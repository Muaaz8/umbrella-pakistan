...
<script type="text/javascript">
    ...
    function delete_price(id)
    {
      $('#del_price').html('<div class="p-5 text-center">'+
        '<a href="/delete/price/'+id+'"><button type="button" class="btn btn-danger delete-m-btn me-2">Delete</button></a>'+
  ...
  input.addEventListener("keypress", function(event) {
    ...
    function search(array)
    {
      ...
      if(val=='')
      {
        window.location.href='/imaging/editor/dash';
      }
      else
      {
        $('#bodies').empty();
        ...
        $.each (array, function (key, arr) {
            ...
            || (arr.address != null && arr.address.toString().match(val)))
          {
            ...
            +'<td>'+arr.zip_code+'</td>'
            +'<td><button onclick="delete_price('+arr.id+')" type="button" class="btn btn-danger">Delete</button></td>'
            );
          }
        });
      }
                  ...
                  <table class="table" id="table">
                    ...
                    <tbody id="bodies">
                      ...
                      <tr>
                        ...
                        <td><button onclick="delete_price({{$record->id}})" type="button" class="btn btn-danger">Delete</button></td>
                      </tr>
                      @empty
                      <tr>
                        <td colspan='4'>
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="deleteeModalLabel">
              You want to delete this pricing?
            </h5>
            <button
              type="button"
              class="btn-close"
