              ...
              <div class="col-md-6 mb-2">
                <div class="card" style="width: 100%">
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex justify-content-between"><b>Payment Status : </b><label class="order-paid">{{ $data['order_data']->order_status }}</label></li>
                    {{-- <li class="list-group-item d-flex justify-content-between"><b>Order Status :  </b><label class="order-paid">{{ $data['order_data']->order_status }}</label></li> --}}
                @else
                    <li class="list-group-item d-flex justify-content-between"><b>Payment Status :</b> <label class="order-progess">{{ $data['order_data']->order_status }}</label></li>
                    {{-- <li class="list-group-item d-flex justify-content-between"><b>Order Status : </b> <label class="order-progress">{{ $data['order_data']->order_status }}</label></li> --}}
                @endif
                    <li class="list-group-item d-flex justify-content-between"><b>Payment Type :</b>{{ $data['payment_method'] }}</li>
                  </ul>
                </div>
              </div>
                    ...
                    <div class="card mt-3">
                      ...
                      <div class="card-body">
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="card" style="width: 100%">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><b>Name : </b> {{  explode('|', $data['billing'][4])[1] }}</li>
                                    <li class="list-group-item"><b>Phone :</b> {{  auth()->user()->phone_number }}</li>
                                    <li class="list-group-item"><b>Email :</b> {{  explode('|', $data['billing'][5])[1] }}</li>
                                    <li class="list-group-item"><b>Address :</b> {{ explode('|', $data['billing'][6])[1] }}</li>
                                  </ul>
                              </div>
                        </div>
                        <div class="col-md-6">
                            <div class="card" style="width: 100%">
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item"><b>Zip : </b> {{ explode('|', $data['billing'][9])[1] }}</li>
                                    <li class="list-group-item"><b>State : </b> {{ explode('|', $data['billing'][8])[1] }}</li>
                                    <li class="list-group-item"><b>City : </b> {{ explode('|', $data['billing'][7])[1] }}</li>
