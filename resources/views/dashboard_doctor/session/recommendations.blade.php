                ...
                <div class="row m-auto">
                  ...
                  <div class="pres-item-sec mt-2">
                    ...
                    <div class="pres-item-sec mt-2" id="pres">
                        <input hidden="" id="pat_id" type="text" name="patient_id" value="{{$getSession->patient_id}}" />
                        ...
                        @if ($pre->mode == 'medicine')
                            <div class="pharmacy-item">
                                ...
                                <div class="d-item2 d-flex align-items-center"><p class="fs-5">{{ $pre->name }}</p>&nbsp;<p class="me-3 ps-3">{{ $pre->usage }}</p></div>
                                <div class="d-item3"><button type="button" onclick="dosage({{ $pre->id }})" class="btn add-dosage-btn">Add Dosage</button></div>
                                <input type="hidden" name="session_id" value="{{ $getSession->id }}">
                                    ...
                                    <div class="d-item4"><a type="button" href="/delete_prescribe_item_from_recom/{{$pre->pres_id}}"><i class="fa-solid fa-circle-xmark fs-4 text-danger"></i></a></div>
                                </div>
                                @php
                                    $added = false;
                                    if($pre->usage != ""){
                        ...
                        @elseif($pre->mode == 'lab-test')
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-item2"><p class="fs-5">{{ $pre->TEST_NAME }}</p></div>
                        ...
                        @elseif($pre->mode == 'imaging')
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-item2 d-flex align-items-center"><p class="fs-5">{{ $pre->name }}</p>&nbsp;<p class="">(Location: {{ $pre->location }})</p></div>
                                <div class="d-item3"></div>
                                    <input type="hidden" name="session_id" value="{{ $getSession->id }}">
                                    <input type="hidden" name="pro_id" value="{{ $pre->id }}">
                                    <input type="hidden" name="type" value="{{ $pre->mode }}">
                    ...
                    <div class="pharmacy-item">
                    @if ($added)
                        <div class="text-center mt-3"><button id="buton" type="submit" class="btn con-recomm-btn butn">CONFIRM RECOMMENDATIONS</button></div>
                    @else
                        <div class="text-center mt-3"><button type="button" onclick="alert('Dosage Required');" class="btn con-recomm-btn">CONFIRM RECOMMENDATIONS</button></div>
                    @endif
                  </div>
                  </div>
                </div>
            ...
            <div class="modal-body">
              <div class="dosage-body">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="instructions" name="instructions" class="bg-light form-control" placeholder="Special Instructions"/>
              </div>
                </div>
                ...
                <form action="">
                  <div class="row m-auto">
                    ...
                    <div class="col-lg-12 d-flex align-items-center">
                      ...
                      <button class="btn zip-search" type="button"><i class="fa-solid fa-magnifying-glass fs-5"></i></button>
                    </div>
                    <!-- <div class="col-lg-2">
                      <div class="px-2 py-2">
                ...
                <div class="btn-wrapper-div">
                  ...
                  <div class="content">
                    <div class="prescriptio-card-wrapper">
                      <div class="card">
                        <div class="card-header fw-bold"><i class="fa-solid fa-capsules"></i> ADD MEDICINES <i class="fa-solid  but" ></i></div>
                        <div class="card-body">
                          <div class="wrap">
                            <div class="search">
                              <input
                              ...
                              <div class="col-md-4">
                                <button class="but1">AHAD</button>
                                  ...
                                  <div class="content1">
                                    <div class="prescriptio-card-wrapper">
                                      <div class="card">
                                        <div class="card-header fw-bold"><i class="fa-solid fa-circle-arrow-left but1"></i> AHAD <i class="fa-solid  but1" ></i></div>
                                        <div class="card-body">
                                          <div class="wrap">
                                            <div class="search">
                                              <input
                  ...
                  <div class="content">
                    <div class="prescriptio-card-wrapper">
                      <div class="card">
                        <div class="card-header fw-bold"><i class="fa-solid fa-flask"></i> ADD LAB TESTS <i class="fa-solid  but"></i></div>
                        <div class="card-body">
                          <div class="wrap">
                            <div class="search">
                              <input
                  ...
                  <div class="content">
                    <div class="prescriptio-card-wrapper">
                      <div class="card">
                        <div class="card-header fw-bold"><i class="fa-solid fa-x-ray"></i>ADD IMAGINGS <i class="fa-solid  but"></i></div>
                        <div class="card-body">
                          <div class="wrap">
                            <div class="search">
                              <input
