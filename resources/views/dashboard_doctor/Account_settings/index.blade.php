...
@section('page_title')
    <title>CHCC - Account Setting</title>
@endsection
                ...
                <div class="py-2">
                    <form action="{{ route('change_password') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <span id="re_new_icon" toggle="#re_new_pass" onclick="myFunction('re_new_pass', 're_new_icon')" class="fa fa-fw fa-eye-slash field-icon toggle-password"></span>
