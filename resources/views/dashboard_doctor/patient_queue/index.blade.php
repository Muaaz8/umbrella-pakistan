                            ...
                            <div class="list bg-white py-3">
                                <div class="row m-0 px-2 pb-4 border-bottom">
                                    <div class="d-flex align-items-center flex-wrap justify-content-between">
                                        ...
                                        <div class="pink-label mx-1">3</div>
                                    </div>
                                </div>
                                <div class="table-responsive-lg">
                                    <table class="table">
                                        <tbody>
                                            <tr class="active">
                                                <th scope="row"><img src="assets/images/user.png" alt=""></th>
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <div class="blue-label">Hasir Umar</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <div class="blue-label">Anas Murtaza</div>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex flex-column">
                                                        <div class="blue-label">Ebad Ahmed</div>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
