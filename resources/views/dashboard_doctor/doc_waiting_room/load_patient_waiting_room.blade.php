                              ...
                              <div class="logo is-animetion">
                               ...
                               <div class="d-flex justify-content-center align-items-center">
                                 <div class="round-image">
                                    <img src="{{$sessions[0]['user_image']}}" class="rounded-circle waiting_patient_img" width="97">
                                 </div>
                               </div>
                               ...
                               <div class="text-center">
                                ...
                                <button id="join_btn1" style="font-size:22px"  class="{{$sessions[0]['session_id']}} join-btn" onclick="joinBtnClick()">Join</button>
