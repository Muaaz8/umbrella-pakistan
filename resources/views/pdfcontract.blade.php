        ...
        <div class="container">
            <div class="card card-custom contractOverflow">
                <div class="card-body p-0">
                    ...
                    <div class="row justify-content-center bgi-size-cover bgi-no-repeat py-8 px-8 py-md-27 px-md-0" style="background-image: url(asset_contract/images/bg-6.jpg); height:150px">
                        <div class="col-md-9">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="295">
                                            ...
                                            <img src="{{$contract->signature}}" style="width:230px; object-fit:contain;">
                                            <!-- <p>&nbsp;</p> -->
                                            <p><u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                </u></p>
