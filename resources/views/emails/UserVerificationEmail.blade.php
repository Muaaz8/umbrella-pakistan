...
<body>
    <!-- ******* Email STATRS ******** -->
    <table class="container container_full" width="100%"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr style="text-align: center;">
                                                                <th class="bg-white" style="padding-top: 15px;">
                                                                    <a href="{{ config('app.url') }}/email/verification/{{ $data['user_id'] }}/{{ $data['hash'] }}"
                                              ...
                                              ">
                                                      ...
                                                      ">
                                                                                                        <img style="height:30px !important;"
                                                                                                            src="https://www.communityhealthcareclinics.com/assets/images/facebook.png"></img>
                                                                                                    </a>
