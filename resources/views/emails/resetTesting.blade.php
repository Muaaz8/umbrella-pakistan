      ...
      <tbody style="background-color: #e4e4e4;">
        <tr>
          <th>
            ...
            <table
              width="600"
              style="margin: auto ;background-color: #ffff;"
                              ...
                              <tbody>
                                ...
                                <tr style="text-align: center;">
                                    <th class="bg-white" style="padding-top: 15px;">
                                       ...
                                       class="btn">Reset Password</button></a>
                                    </th>
                                  </tr>
...
{{-- <a href="{{ $reset_url }}" target="_blank" style="color: #ffffff !important; cursor:pointer !important; ">Reset Password</a> --}}
