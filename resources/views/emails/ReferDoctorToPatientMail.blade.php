...
<html lang="en">
  <head>
    ...
    <title>New Doctor Referred</title>
  </head>
  <body>
    <!-- ******* Email STATRS ******** -->
    <table
    ...
    >
      <tbody  style="background-color: #e4e4e4 !important;">
        <tr>
          <th>
            ...
            >
              <tbody style="background: #ffff !important">
                <tr>
                  <th>
                          ...
                          <td class="bg-light">
                            <table>
                              ...
                              <tbody>
                                ...
                                <tr>
                                  <th style="padding: 0px 45px; background: #fff; !important">
                                    <p
                                    style="
                                      font-size: 16px;
                                    ...
                                    "
                                  >
                                  Hi Mr./Ms {{ ucwords($data['pat_name']) }},
                                  </p>
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                    Your Dr.{{ $data['ref_from_name'] }} has referred you to Dr.{{ $data['ref_to_name'] }}. Please go to the Umbrella Health Care Systems web portal to make an appointment.
                                  <br>
                                  <br>
                                ...
                                <tr style="text-align: center;">
                                    <th class="bg-white" style="padding-top: 15px;">
                                      <a href="{{ config('app.url') }}/home"><button style="background-color: #08295a !important;
                                        color: #fff !important; border:none; padding:5px 15px; cursor:pointer !important; "
                                         >Web Portal</button></a>
                                    </th>
                                  </tr>
