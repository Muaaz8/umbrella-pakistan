                              ...
                              <tr>
                                <th style="padding: 0px 45px; background: #fff;">
                                  ...
                                  <p style="
                                    ...
                                    Mr./Ms{{ $data['pat_name'] }} appointment with Dr.{{ $data['doc_name'] }} on {{ $data['date']." ".$data['time'] }} has been cancelled.
                                    Please make an refund transaction for this appointment.
