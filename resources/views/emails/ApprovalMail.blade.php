                            ...
                            <tbody>
                                ...
                                <th style="padding: 0px 45px; background: #fff;">
                                  ...
                                  <p style="
                                      ...
                                      ">
                                        ...
                                        Lab Editor Assigned you a Lab with Order Id . {{ $data['order_id'] }}
                              ...
                              <tr style="text-align: center;">
                                <th class="bg-white" style="padding-top: 15px;">
                                    <a href="{{ route('home') }}"><button type="button"  style="background-color: #08295a !important;
                                        ...
                                        <th width="50%" style="
                                          ...
                                          <table width="100%" style="
                                            ...
                                            <tbody>
                                              ...
                                              <!-- Store Address : BEGIN -->
                                              <tr style="text-align: center;">
                                                <th class="d-flex justify-content-evenly" width="100%"
                                                  style="padding-right: 5%;">
                                                  <a class="social-link" href="https://www.facebook.com/CommunityHealthcareClinics" target="_blank" title="Facebook"
                                                    style="
                                                        color: grey;
                                                        ...
                                                        text-align: center;
                                                      ">
                                                      <img src="https://www.communityhealthcareclinics.com/assets/images/facebook.png" style="height:30px !important;"></img>

                                                  </a>
                                                  
                                                  <a class="social-link" href="https://www.instagram.com/community_healthcare_clinics" target="_blank" title="instagram"
                                                    style="
                                                        color: grey;
                                                        text-decoration: none !important;
                                                        text-decoration: none;
                                                  ...
                                                  <a class="social-link" href="https://www.linkedin.com/company/community-health-care-clinics/" target="_blank" title="linkedin"
                                                    style="
                                                        color: grey;
                                                        text-decoration: none !important;
                                                        text-decoration: none;
