...
<head>
    ...
    <title>Provider's Contract</title>
</head>
                                      ...
                                      ">
                                                            ...
                                                            <tr style="text-align: center;">
                                                                <th class="bg-white" style="padding-top: 15px;">
                                                                    <a href="{{ config('app.url') }}{{ $url }}" target="_blank"><button type="button"
                                                                        style="background-color: #08295a !important;
                                                                        color: #fff !important;border:none; padding:5px 15px; cursor: pointer !important;"
                                                                        class="btn">View Contract</button></a>
                                                                </th>
                                                            </tr>
