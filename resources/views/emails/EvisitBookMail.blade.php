...
<html lang="en">
  <head>
    ...
    <title>e-visit payment invoice</title>
  </head>
  <body>
    <!-- ******* Email STATRS ******** -->
    <table
                                ...
                                <tr>
                                  <th style="padding: 0px 45px;background: #fff;">
                                    ...
                                    <p
                                      ...
                                      "
                                    >
                                      Your payment for an E-visit session with Dr. {{ ucwords($data['doc_name']) }} has been <br>
