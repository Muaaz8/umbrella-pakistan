...
<head>
  ...
  <title>Prescription By Doctor</title>
</head>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <th style="padding: 0px 45px; background: #fff;">
                                  ...
                                  <p style="
                                        ...
                                        padding: 9px 20px;
                                      ">
                                    Your doctor has prescribed following items.
                                  </p>
                              ...
                              <tr class="bg-white">
                                <th style="padding: 0px 45px;">
                                  ...
                                  @foreach ($data[1]['rec_test'] as $test)
                                  <p style="
                                          font-size: 16px;
                                    ...
                                    <span style="
                                      font-size: 20px;
                                        font-weight: 600;">
                                      Item Name:{{ $test['test_name'] }}</span>
                                    <br>
                                    <span>Quantity: {{ $test['quantity'] }}</span>
                                    <br>
                                    {{-- <span>Comment: {{ $test['comment'] }} </span> --}}
                                  </p>
                                  @endforeach
                              ...
                              <tr class="bg-white">
                                <th style="padding: 0px 45px;">
                                  ...
                                  @foreach ($data[2]['rec_pharma'] as $pharma)
                                  <p style="
                                          font-size: 16px;
                                    ...
                                    <span style="
                                      font-size: 20px;
                                        font-weight: 600;">
                                      Item Name: {{ $pharma['medicine_name'] }}</span>
                                    <br>
                                    <span>Quantity: {{ $pharma['quantity'] }}</span>
                                    <br>
                                    <span>Dosage : {{ $pharma['usage'] }}</span>
                                    <br>
                                    <span>Comment: {{ $pharma['comment'] }}</span>
                                  </p>
                                  @endforeach
                              ...
                              <tr class="bg-white">
                                <th style="padding: 0px 45px;">
                                  ...
                                  @foreach ($data[3]['rec_imaging'] as $imaging)
                                  <p style="
                                          font-size: 16px;
                                    ...
                                    <span style="
                                      font-size: 20px;
                                        font-weight: 600;">
                                      Item Name : {{ $imaging['imaging_name'] }}</span>
                                    <br>
                                    <span>Quantity: {{ $imaging['quantity'] }}</span>
                                    <br>
                                    {{-- <span>Comment: {{ $imaging['comment'] }} </span> --}}
                                  </p>
                                  @endforeach
