...
<html>
    ...
    <tr>
                                     ...
                                     <tbody><tr><td align="center" style="font-family:'Josefin Sans', Arial, Helvetica, sans-serif;font-size: 30px;color: #282828;">Appointment Rescheduled</td></tr>
                                     </tbody></table>
                                ...
                                <tr><td class="container-padding" align="center" bgcolor="#F5F5F3">
                                         <table class="row" border="0" width="480" cellpadding="0" cellspacing="0" align="center">
                                             ...
                                             <tr><td style="font-family:'Open Sans', Arial, Helvetica, sans-serif;font-size: 14px;color: #282828;line-height: 22px">
                                                    ...
                                                    Your appointment with Dr.{{ $data['doc_name'] }} has been rescheduled on {{ $data['date'] }} at {{ $data['time'] }}<br>
                                            ...
                                            <tbody>
                                                       ...
                                                       <table border="0" width="100%" cellpadding="0" cellspacing="0" align="center" style="width:100%; max-width:100%;">
                                                          <tbody>
                                                            ...
                                                            <tr>
                                                                                <td align="center" style="font-family:'Roboto', Arial, Helvetica, sans-serif;font-size: 13px;color: #dadada;line-height: 19px">This email was sent to : <p style="color:white !important;">{{ $data['pat_mail'] }}</p><br>
