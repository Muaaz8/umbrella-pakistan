...
<head>
  ...
  <title>Lab Requisition File</title>
</head>
    ...
    <tbody style="background-color: #e4e4e4;">
      <tr>
        <th>
          ...
          <table width="600" style="margin: auto; background-color: #ffff;" class="email-container">
            <tbody>
              <tr>
                <th>
                              ...
                              <tr>
                                <th style="
                                  ...
                                  <a href="https://www.communityhealthcareclinics.com/" target="_blank">
                                    <img src="https://www.communityhealthcareclinics.com/assets/new_frontend/logo.png" style="
                                          width: 200px;
                                          display: block;
                                          margin: auto;
                                        " />
                              ...
                              <tr>
                                <th style="padding: 0px 45px; background: #fff;">
                                  ...
                                  <p style="
                                        ...
                                        padding: 9px 20px;
                                      ">
                                    Please download the requisition file by Quest Diagnostics given below and bring it
                                    with
                                    you in printed form or show it on your mobile phone when you visit the
                                    nearest Quest Diagnostics Lab
                                  </p>
                                  <p style="text-align:center;background: #f9f9f9; margin: 0;">
                                    @if($order->patient->user_type == 'patient')
                                    <a href="{{ config('app.url') }}/patient/lab/requisition" target="_blank">
                                    <button type="button" style="background-color: #08295a !important;
                                    color: #fff !important; border:none; padding:5px 15px; cursor: pointer !important;" class="btn">Open Requisition
                                      File</button></a>
                                    @else
                                    <a href="{{ config('app.url') }}/doctor/lab/requisition" target="_blank">
                                      <button type="button" style="background-color: #08295a !important;
                                      color: #fff !important; border:none; padding:5px 15px; cursor: pointer !important;" class="btn">Open Requisition
                                        File</button></a>
                                    @endif
                                      <a href="https://www.google.com/maps/search/Quest+Diagnostics/" target="_blank">
                                        <button type="button" style="background-color: #08295a !important;
                                    color: #fff !important; padding:5px 15px; border:none; cursor: pointer !important;" class="btn">My Nearby Quest
                                      Diagnostics Labs</button></a>
                                  </p>
