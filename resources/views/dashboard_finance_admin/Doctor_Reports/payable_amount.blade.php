...
$(function() {
  ...
  $('input[name="ses_date"]').on('cancel.daterangepicker', function(ev, picker) {
    $(this).val('');
    var id = $('#user_id').val();
    window.location.href="/doctors/payable/"+id;
  });
});
                  ...
                  <div class="col-md-12">
                    <div class="row m-auto">
                        ...
                        <div class="d-flex align-items-baseline flex-wrap justify-content-between">
                            <div>
                              ...
                              <div class="d-flex flex-wrap justify-content-between">
                                <div class="dropdown">
                                    <button class="btn process-pay me-2 mb-1 dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                      Download Data
                                    </button>
                                  ...
                                  <div>
                                    <!-- <button class="btn process-pay px-5">Pay</button> -->
                                  </div>
                                </div>
                        </div>
                      </div>
                      <div class="wallet-table">
                        ...
                        {{ $payable->links('pagination::bootstrap-4') }}
