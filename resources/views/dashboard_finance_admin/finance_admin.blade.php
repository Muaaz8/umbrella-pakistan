                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane container fade" id="precriptionItems">
                                <div class="row mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                        <input type="text" class="form-control" name="pres_date" id="pres_date" placeholder="filter record by date-range">
                                        </div>
                                        <div class="col-md-5">
                              ...
                              <div class="tab-pane container fade" id="onlineItems">
                                <div class="row mb-2">
                                    <div class="col-md-3 d-flex">
                                        <input type="text" class="form-control me-1" name="" id="" placeholder="Search" hidden="">
                                        <input type="text" class="form-control" name="online_date" id="online_date" placeholder="filter record by date-range">
                                    </div>
