...
white-space: nowrap;
        padding: 20px;
        margin-bottom: 10px;">
            <div style="margin-bottom: 10px; text-align:center; color:black;"><strong>Online Labs Earning Details Of Dr.{{$ot->doc_name}}</strong></div>
            ...
            <div class="payment-div" style="  margin-top:10px  padding: 10px;
            border: 1px solid #d5d5d585; width: 50%; float: right;">
                ...
                <div><span>Doctor Fee:</span> &nbsp; &nbsp;<span class=" fw-bold float-end">$3.00</span></div>
            </div>
        </div>
@endforeach
