                        ...
                        <div class="d-flex align-items-end p-0">
                            ...
                            <div class="col-md-3 ms-auto p-0">
                              <div class="d-flex justify-content-between">
                                ...
                                <button class="btn btn-success w-100 me-2" data-bs-toggle="modal" data-bs-target="#deactivate_user">Activate</button>
                                @else
                              ...
                              <div class="">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <th scope="row">{{ $psc->id }}</th>
                                      <td>{{ $psc->title }}</td>
                                      <td>{{ $psc->parent_id }}</td>
                                      <td>{{ $psc->parent_name }}</td>
                                      <td>
