                    ...
                    <div class="row py-2">
                        <div class="col-md-4">
                            ...
                            <select class="form-select" aria-label="Default select example">
                                ...
                                <option @if($banner->page_name == "home") selected @endif value="home">Home</option>
                                <option @if($banner->page_name == "labtests") selected @endif value="labtests">Lab</option>
                                <option @if($banner->page_name == "pharmacy") selected @endif value="pharmacy">Pharmacy</option>
                                <option @if($banner->page_name == "imaging") selected @endif value="imaging">Imaging</option>
                              </select>
                        </div>
