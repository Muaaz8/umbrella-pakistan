  ...
  $.ajax({
        ...
        success: function(data) {
          ...
          $.each (data, function (key, ses) {
            ...
            $('#eVisit').append('<div class="accordion accordion-flush " id="accordionFlushExample_'+ses.id+'">'
            +'<div class="accordion-item mb-2">'
            +'<h2 class="accordion-header" id="flush-heading_'+ses.id+'">'
            +'<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" '
            +'data-bs-target="#flush-collapse_'+ses.id+'" aria-expanded="false" aria-controls="flush-collapse_'+ses.id+'">'
            +'<div class="accord-data"><div><i class="fa fa-users"></i>&nbsp; Session ID &nbsp;<span>UEV-'+ses.session_id+'</span></div>'
            +'<div>Earning <strong>$'+ses.Net_profit+'</strong></div>'
            +'<div>'+ses.datetime['time']+','+ses.datetime['date']+' &nbsp;<a class="btn process-pay" href="#" '
            +'role="button">Details&nbsp;<i class="fa fa-arrow-down"></i></a></div>'
            +'</div></button></h2><div id="flush-collapse_'+ses.id+'" class="accordion-collapse collapse" aria-labelledby="flush-heading_'+ses.id+'" data-bs-parent="#accordionFlushExample_'+ses.id+'">'
            +'<div class="accordion-body"><div class="session-id-details"><div class="flexone"><p class="fw-bold">Dr.'+ses.doc_name+'</p><p>Session with:</p><p>Patient: '
            +'<span class="fw-bold">'+ses.pat_name+'</span></p></div><div class="flextwo">'
            +'<div><span> Patient Paid</span> <span>+$ &nbsp;'+ses.price+'</span></div>'
            +'<div>Doctor '+ses.doc_percent+'%<span class="text-danger">-$ &nbsp;'+ses.doc_price+'</span></div>'
            +'<div>Credit card Fee <span class="text-danger">-$ &nbsp;'+parseFloat(ses.card_fee)+'</span></div>'
          ...
          $('#eVisit').append('<div class="accordion accordion-flush " id="accordionFlushExample">'
            ...
            +'<div class="accord-data"><div><i class=""></i>&nbsp; Total Sessions: &nbsp;<span>'+data.length+'</span></div>'
            +'<div><i class="fa fa-usd"></i>&nbsp;Total Earning: <strong>'+total+'</strong></div>'
            +'<div>'+date+' &nbsp;</div>'
            +'</div></button><div><div>'
            );
  ...
  $.ajax({
        ...
        success: function(data) {
          ...
          $.each (data, function (key, pres) {
            ...
            {
              $('#precriptionItem').append('<div class="accordion accordion-flush " id="accordionFlushExample_'+pres.order_id+'">'
              +'<div class="accordion-item mb-2">'
              ...
              +'<div class="accord-data"><div><i class="<i class="fa-solid fa-capsules"></i></i>&nbsp; Order ID: &nbsp;<span>'+pres.order_id+'</span></div>'
              +'<div><strong>Session ID : &nbsp;<span> UEV-'+pres.ses_id+'</span></strong></div>'
              +'<div>'+pres.datetime['time']+','+pres.datetime['date']+' &nbsp;<a class="btn process-pay" href="#" '
              +'role="button">Details&nbsp;<i class="fa fa-arrow-down"></i></a></div>'
              +'</div></button></h2><div id="flush-collapse_'+pres.order_id+'" class="accordion-collapse collapse" aria-labelledby="flush-heading_'+pres.order_id+'" data-bs-parent="#accordionFlushExample_'+pres.order_id+'">'
              +'<div class="accordion-body" id="accorbody_'+pres.order_id+'"><div class="p-3"><div class="row mb-1">'
              +'<div class="col-md-4"><b>Product Name:</b> '+pres.name+'</div>'
              +'<div class="col-md-4"><b>Product ID:</b> '+pres.pro_id+'</div>'
              +'<div class="col-md-4"><b>Product type:</b> '+pres.type+'</div></div>'
              +'<div class="row"><div class="col-md-4"><b>Dosage Days:</b> '+pres.usage+'</div>'
            ...
            {
              $('#accorbody_'+pres.order_id).append('<div class="p-3"><div class="row mb-1">'
              +'<div class="col-md-4"><b>Product Name:</b> '+pres.name+'</div>'
              +'<div class="col-md-4"><b>Product ID:</b> '+pres.pro_id+'</div>'
              +'<div class="col-md-4"><b>Product type:</b> '+pres.type+'</div></div>'
              +'<div class="row"><div class="col-md-4"><b>Dosage Days:</b> '+pres.usage+'</div>'
              +'<div class="col-md-4"><b>Selling Price:</b> $'+pres.sale_price+'</div>'
              +'<div class="col-md-4"><b>Price:</b> $'+pres.price+'</div></div></div>'
              );
            }
            oid = pres.order_id;
          });

          $('#precriptionItem').append('<div class="accordion accordion-flush " id="accordionFlushExample">'
            +'<div class="accordion-item mb-2">'
            +'<h2 class="accordion-header" id="flush-heading">'
            +'<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" '
            +'data-bs-target="#flush-collapse" aria-expanded="false" aria-controls="flush-collapse">'
            +'<div class="accord-data"><div><i class=""></i>&nbsp; Total Prescriptions: &nbsp;<span>'+data.length+'</span></div>'
            +'<div><i class="fa fa-usd"></i>&nbsp;Total Earning: <strong>'+total+'</strong></div>'
            +'<div>'+date+' &nbsp;</div>'
            +'</div></button><div><div>'
            );
  ...
  $.ajax({
        ...
        success: function(data) {
          ...
          $.each (data, function (key, on) {
            ...
            $('#onlineItem').append('<div class="accordion accordion-flush " id="accordionFlushExample_'+on.id+'">'
            +'<div class="accordion-item mb-2">'
            +'<h2 class="accordion-header" id="flush-heading_'+on.id+'">'
            +'<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" '
            +'data-bs-target="#flush-collapse_'+on.id+'" aria-expanded="false" aria-controls="flush-collapse_'+on.id+'">'
            +'<div class="accord-data"><div><i class="<i class="fa-solid fa-capsules"></i></i>&nbsp; Product Name: &nbsp;<span>'+on.name+'</span></div>'
            +'<div><strong></strong></div>'
            +'<div>'+on.datetime['time']+','+on.datetime['date']+' &nbsp;<a class="btn process-pay" href="#" '
            +'role="button">Details&nbsp;<i class="fa fa-arrow-down"></i></a></div>'
            +'</div></button></h2><div id="flush-collapse_'+on.id+'" class="accordion-collapse collapse" aria-labelledby="flush-heading_'+on.id+'" data-bs-parent="#accordionFlushExample_'+on.id+'">'
            +'<div class="accordion-body"><div class="p-3"><div class="row mb-1">'
            +'<div class="col-md-6"><b>Order ID:</b> '+on.order_id+'</div>'
            +'<div class="col-md-6"><b>Product ID:</b> '+on.product_id+'</div></div>'
            +'<div class="row"><div class="col-md-6"><b>Selling Price:</b> $'+on.sale_price+'</div>'
            +'<div class="col-md-6"><b>Price:</b> $'+on.price+'</div>'
            +'</div></div></div></div></div></div>'

            );
          });
          $('#onlineItem').append('<div class="accordion accordion-flush " id="accordionFlushExample">'
            +'<div class="accordion-item mb-2">'
            +'<h2 class="accordion-header" id="flush-heading">'
            +'<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" '
            +'data-bs-target="#flush-collapse" aria-expanded="false" aria-controls="flush-collapse">'
            +'<div class="accord-data"><div><i class=""></i>&nbsp; Total Items: &nbsp;<span>'+data.length+'</span></div>'
            +'<div><i class="fa fa-usd"></i>&nbsp;Total Earning: <strong>'+total+'</strong></div>'
            +'<div>'+date+' &nbsp;</div>'
            +'</div></button><div><div>'
            );
                          ...
                          <section class="sec-2">
                            ...
                            <ul class="nav nav-tabs">
                              <li class="nav-item col-md-3 col-12">
                                <a class="nav-link active" data-bs-toggle="tab" href="#eVisits"
                                  >E-Visit</a
                                >
                              </li>
                              <li class="nav-item col-md-3 col-12">
                                <a class="nav-link" data-bs-toggle="tab" href="#precriptionItems"
                                  >Prescription Items</a
                                >
                              </li>
                              <li class="nav-item col-md-3 col-12">
                                <a class="nav-link" data-bs-toggle="tab" href="#onlineItems"
                                  >Online Items</a
                                >
                              </li>
                            </ul>
                            ...
                            <div class="tab-content">
                              ...
                              <div class="tab-pane container active tab-pad" id="eVisits">
                                <div class="row mb-2">
                                  <div class="col-md-6 d-flex">
                                      <div class="row">
                                        <div class="col-md-7">
                                          <input type="text" class="form-control mb-2" name="session_date" id="session_date" placeholder="filter record by date-range">
                                        </div>
                                        <div class="col-md-5">
                                  ...
                                  <div class="col-md-6 text-end">
                                      <div class="dropdown">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="#" onclick="generate_csv('ses')">Download As CSV</a></li>
                                            <li><a class="dropdown-item" href="#" onclick="generate_pdf('ses')" id="ses">Download As PDF</a></li>
                                          </ul>
                                        </div>
                                  </div>
                                </div>
                              ...
                              <div class="tab-pane container fade" id="precriptionItems">
                                <div class="row mb-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-7">
                                        <input type="text" class="form-control mb-2" name="pres_date" id="pres_date" placeholder="filter record by date-range">
                                        </div>
                                        <div class="col-md-5">
                                          <input type="text" class="form-control mb-2" name="pres_search_id" id="pres_search_id" onchange="prescriptions()" placeholder="Search By SessionID">
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-md-6 text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                              <li><a class="dropdown-item" href="#" onclick="generate_csv('pres')">Download As CSV</a></li>
                                              <li><a class="dropdown-item" href="#" onclick="generate_pdf('pres')">Download As PDF</a></li>
                                            </ul>
                                          </div>
                                    </div>
                                        ...
                                        <h2 class="accordion-header" id="flush-heading_{{$press->order_id}}">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse_{{$press->order_id}}" aria-expanded="false" aria-controls="flush-collapse_{{$press->order_id}}">
                                                <div class="accord-data">
                                                    ...
                                                    <div>{{$press->datetime['time']}},{{$press->datetime['date']}} &nbsp;</div>
                                                    <a class="btn process-pay d-flex align-items-baseline" href="#" role="button">Details&nbsp;<i class="fa fa-arrow-down"></i></a>
                                                  </div>
                                            </button>
                                          </h2>
                              ...
                              <div class="tab-pane container fade" id="onlineItems">
                                <div class="row mb-2">
                                    <div class="col-md-3 d-flex">
                                        <input type="text" class="form-control me-1" name="" id="" placeholder="Search" hidden="">
                                        <input type="text" class="form-control mb-2" name="online_date" id="online_date" placeholder="filter record by date-range">
                                    </div>
                                    <div class="col-md-9 text-end">
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                              <li><a class="dropdown-item" href="#" onclick="generate_csv('on')">Download As CSV</a></li>
                                              <li><a class="dropdown-item" href="#" onclick="generate_pdf('on')">Download As PDF</a></li>
                                            </ul>
                                          </div>
                                    </div>
