    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>Schedule Form<small>Fill the form below</small> </h2>
					</div>
					<div class="body" >
                        <form method="POST" action="{{ route('schedule_add.store') }}" enctype="multipart/form-data">
                        @csrf
                ...
                <div id="time-range" style="margin-right: 0px">
                    ...
                    <p>Availability Time Range:
                        <input type="text" name="from_time" class="slider-time m-2 col-md-4 " style="margin-left: 2%" value="9:00 AM" readonly=""> -
                        <input type="text" name="to_time" class="slider-time2 m-2 col-md-4" value="5:00 PM" readonly="">
...
@section('script')
<script src="asset_admin/plugins/jquery-ui/jquery-ui.js"></script>
