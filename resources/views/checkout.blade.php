...
@section('content')
    ...
    <div class="full-page base-color">
        ...
        <div class="container">
            ...
            <form method="post" action="{{ url('/new/create_order') }}" enctype="multipart/form-data" id="checkoutForm">
                {{ csrf_field() }}
                <div class="row mb-5">
                    <div class="col-md-8">
                        <div class="card p-0 card-border">
                            ...
                            <div class=" mb-4">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-3 pl-0 pr-0">
                                        <div class="mt-3 mr-2"> <input type="text" name="billing[phone_number]" required
                                                class="form-control" placeholder="Phone"
                                                value="{{ isset($user) ? $user->phone_number : '' }}"> </div>
                                    </div>
                                    <div class="col-md-3 pl-0">
                                        <div class="mt-3 mr-2"> <input type="email" name="billing[email_address]" required
                                    ...
                                    <div class="col-md-12">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="mt-3 mr-2 mb-1">
                                                <input onkeyup="if(this.value<0){this.value= this.value * -1}"
                                                    type="number" name="payment[cvc]" class="form-control"
                                                    placeholder="CSC" readonly value="998" required>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4 pr-0">
                                        <div class="mt-3 mr-2">
                                            <input type="number" onkeyup="if(this.value<0){this.value= this.value * -1}"
                                                name="billing[zip_code]" required class="form-control checkout_zipcode"
                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                 maxlength="5"
                                                placeholder="Zip Code" {{-- value="{{ isset($user) ? $user->zip_code : '' }}" --}} required>
                                            <p class="text-danger checkoutErrSpan zipCodeErrCheckout">Please Enter A valid
                                                ZipCode</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 pl-0 pr-0">
                                        <div class="mt-3 mr-2" style=" padding-left: 6px; ">
                                            ...
                                            <p class="text-danger checkoutErrSpan stateErrCheckout">No State Found Against
                                                ZipCode</p>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-12">
                                        <div class="mt-3 mr-2">
                                            <textarea type="text" name="billing[additional_notes]" class="form-control" placeholder="Additional Notes"></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                @if ($data['AOEsCount'] > 0)
                                    @foreach ($data['AOEs']['AOECollection'] as $key => $collections)
                                        @foreach ($collections as $collection)
                                            <input type="hidden" value="{{ $collection['answer'] }}" class="form-control" name="AOEs[{{ $collection['TestCode'] }}][{{ $collection['QuestionLong'] }}|{{ $collection['TestCode'] }}]" required>
                                        @endforeach
                                    @endforeach
                                @endif
                                                    ...
                                                    <div class="ship_hide display">
                                                        ...
                                                        <div class="row mt-2">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mt-3 mr-2 pl-2">
                                                                    <input type="hidden" name="shipping[state]"
                                                                        ...
                                                                        value="">
                                                                    <select
                                                                        class="form-control states_select_for_shipping shipping-width"
                                                                        name="shipping[state_code]"
                                                                        onChange="getCitiesByStateForShipping(this.value);">
                                                                        <option value="" default>Select State
                                                                        </option>
                                                                        @forelse ($data['countries'] as $state)
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="mt-3 mr-2">
                                                                    <select
                                                                        class="form-control city_select_for_shipping shipping-width"
                                                                        name="shipping[city]">
                                                                    </select>
                                                                </div>
                                                            </div>
...
@section('script')
    <script defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCRPRccs93XYIWyD-1I5ygtkzQ_ROCFafU&callback=initMap"></script>
