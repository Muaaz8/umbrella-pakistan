    ...
    <nav>
      <section id="navbar">
        ...
        <div class="flex gap-15" id="nav-left-side">
            ...
            <a href="{{ route('about_us') }}">About Us</a>
            <a href="{{ route('contact_us') }}">Contact Us</a>
            <a href="{{ route('doc_profile_page_list', ['online' => true]) }}" class="text-success online_docs d-flex gap-1 align-items-center"><span class="blink-dot"></span><span>Online Doctors</span></a>
