...
@endphp
<footer class="new-footer py-2 pt-sm-5 pb-sm-4">
    <section class="container-fluid px-0">
        <div
            class="row gy-2 gy-sm-2 gy-md-3 gx-lg-4 w-85 mx-auto justify-content-between justify-content-sm-start justify-content-md-between"
        >
            <div
            class="col-sm-6 col-md-4 col-lg-4 d-flex flex-column justify-content-between mt-0 px-md-0"
            >
            ...
            >
                <a target="_blank" href="https://www.facebook.com/share/15m4ofYggZ/"><i class="fa-brands fa-facebook-f"></i></a>
                <a target="_blank" href="https://www.linkedin.com/company/community-health-care-clinics/"><i class="fa-brands fa-linkedin-in"></i></a>
                <a target="_blank" href="https://www.instagram.com/community_healthcare_clinics?igsh=MXh6aHRzM2NrNThlMw=="><i class="fa-brands fa-instagram"></i></a>
                <a target="_blank" href="https://www.youtube.com/@CommunityHealthcareClinics"><i class="fa-brands fa-youtube"></i></a>
                <a target="_blank" href="https://www.tiktok.com/@community.healthc"><i class="fa-brands fa-tiktok"></i></a>
            </div>
            </div>
            <div
            class="col-6 col-sm-6 col-md-4 col-lg-1 social-links-section mt-2 mt-sm-0 px-md-0"
            >
            ...
            <div
            class="col-6 col-sm-6 col-md-4 col-lg-2 mt-2 mt-sm-4 mt-md-0 working-hours-section px-md-0"
            >
            ...
            <ul class="list-unstyled mt-3 links d-flex flex-column gap-2">
                <li class="fs-14"><a href="tel:+14076938484"><span class="fw-semibold">Phone:</span> +1 (407) 693-8484</a></li>
                <li class="fs-14">
                <a target="_blank" href="https://maps.google.com/maps?ll=24.863264,67.074398&z=15&t=m&hl=en&gl=US&mapclient=embed&cid=11049335347165757010">
          ...
          <div class="col-sm-12 px-0">
            <div
              class="w-100 d-flex gap-2 gap-lg-0 flex-wrap align-items-center justify-content-between"
            >
