...
@section('page_title')
    <title>Manage Lab Editors</title>
@endsection
...
<script type="text/javascript">
  ...
  input.addEventListener("keypress", function(event) {
    ...
    function search(array)
    {
      ...
      if(val=='')
      {
        window.location.href='/lab/admin/dash';
      }
      else
      {
        $('#editors').empty();
                        ...
                        <div class="p-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="role" value="lab" class="form-control" placeholder="">
                                </div>
                            </div>
                            <div class="row mt-2">
                              <div class="col-md-12">
