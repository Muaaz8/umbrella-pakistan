...
@section('page_title')
    <title>Lab Editor Details</title>
@endsection
...
@section('content')
    <div class="dashboard-content">
                        ...
                        <div class="d-flex justify-content-between flex-wrap align-items-end p-0">
                            ...
                            <div class="col-12 col-sm-7 col-md-5 p-0">
                              <div class="d-flex justify-content-between">
                                ...
                                <button class="btn btn-danger w-100 me-2" data-bs-toggle="modal" data-bs-target="#deactivate_user">Deactivate</button>
                                @else
                                <button class="btn btn-danger w-100 me-2" data-bs-toggle="modal" data-bs-target="#deactivate_user">Deactivate</button>
                                @endif
                                <button class="btn process-pay w-100" data-bs-toggle="modal" data-bs-target="#send_email_user">Send Email</button>
                              </div>
                            </div>
                          </div>
                      <div class="p-0">
                        <div class="pt-2">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                      <li><a class="dropdown-item" href="#" id="product-tab" data-bs-toggle="tab" data-bs-target="#product" type="button" role="tab" aria-controls="product" aria-selected="true">Product</a></li>
                                      <li><a class="dropdown-item" href="#" id="categories-tab" data-bs-toggle="tab" data-bs-target="#categories" type="button" role="tab" aria-controls="categories" aria-selected="true">Categories</a></li>
                                      <li><a class="dropdown-item" href="#" id="subcategories-tab" data-bs-toggle="tab" data-bs-target="#subcategories" type="button" role="tab" aria-controls="subcategories" aria-selected="true">Subcategories</a></li>
                                    </ul>
                                  </li>
                                <li class="nav-item" role="presentation">
                                    ...
                                    <div class="">
                                      ...
                                      <table class="table">
                                        ...
                                        <tbody>
                                          ...
                                          <tr>
                                            <td data-label="Name">{{$pro->name}}</td>
                                            @foreach($pro->cat_names as $cat_name)
                                            <td data-label="Category Name">{{$cat_name['name']}}</td>
                                            @endforeach
                                            <td data-label="Sale Price">{{$allProduct->sale_price}}</td>
                                            <td data-label="Action">
                                                <button type="button" class="btn orders-view-btn" data-bs-toggle="modal" data-bs-target="#product_view_details">View</button>
                          ...
                          <div class="tab-pane fade show" id="subcategories" role="tabpanel" aria-labelledby="subcategories-tab">
                            <div class="row m-auto">
                              <div class="">
                                ...
                                <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      <td data-label="Sub ID">{{ $productsSubCategory->id }}</td>
                                      <td data-label="Sub Title">{{ $productsSubCategory->title }}</td>
                                      <td data-label="Main ID">{{ $productsSubCategory->parent_id }}</td>
                                      <td data-label="Main Title">{{ $productsSubCategory->parent_name }}</td>
                                      <td data-label="Action">
                                        <button type="button" class="btn orders-view-btn" data-bs-toggle="modal" data-bs-target="#product_subcategory_details">View</button>
                                      </td>
                                    </tr>
                                    @empty
                                    <tr>
                              ...
                              <div class="row m-auto">
                                <div class="col-md-3">
                                  ...
                                  >
                                    ...
                                    <a
                                      class="nav-link mb-3 p-3 shadow"
                                      id="v-pills-imaging-tab"
                                      data-bs-toggle="pill"
                                      data-bs-target="#v-pills-imaging"
                                      type="button"
                                      role="tab"
                                      aria-controls="v-pills-imaging"
                                      aria-selected="false"
                                    >
                                ...
                                <div class="col-md-9">
                                  ...
                                  <div class="tab-content" id="v-pills-tabContent">
                                    ...
                                    <div
                                      class="tab-pane fade shadow rounded show active bg-white p-4"
                                      id="v-pills-settings"
                                      role="tabpanel"
                                    ...
                                    <div class="row m-auto">
                                      <div class="">
                                        <table class="table">
                                          ...
                                          <tbody>
                                            <tr>
                                              <td scope="row">MiraLAX Laxative Powder</td>
                                              <td>Pain & Fever</td>
                                              ...
                                              <td>
                                                  ...
                                                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_specailization_price">View</a></li>
                                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_specailization_price">Edit</a></li>
                                                    <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_specialization">Deactivate</a></li>
                                                  </ul>
                                                </div>
                                              </td>
                                            </tr>
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_product_category">Edit</a></li>
                                                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_specialization">Delete</a></li>
                                                    </ul>
                                                  </div>
                                                </td>
                                              </tr>
                                            ...
                                            <tbody>
                                              <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_specailization_price">View</a></li>
                                                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#edit_product_subcategory">Edit</a></li>
                                                      <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_specialization">Deactivate</a></li>
                                                    </ul>
                                                  </div>
                                                </td>
                                    ...
                                    <tbody>
                                      <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                              <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_specailization_price">View</a></li>
                                              <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#add_specailization_price">Send Email</a></li>
                                              <li><a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#delete_specialization">Deactivate</a></li>
                                            </ul>
                                          </div>
                                        </td>
                                ...
                                <div class="row m-auto">
                                    ...
                                    <table class="table">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            <td data-label="Activity">{{ucwords($act->activity)}}</td>
          ...
          <!-- ------------------Product-View-Details-Modal-start------------------ -->
            ...
            <!-- Modal -->
            <div class="modal fade" id="product_view_details" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                        ...
                        <form action="">
                          ...
                          <div class="row mt-2">
                            <div class="col-md-12">
                              <p><span class="fw-bold">Short Description:</span> <span>Tylenol is used to reduce fever and relieve minor pain caused by conditions such as colds or flu,&nbsp;headache, muscle aches,&nbsp;arthritis, menstrual cramps and&nbsp;fevers.</span></p>
                          </div>
                          </div>
                          <div class="row mt-2">
                            <div class="col-md-12">
                              <p><span class="fw-bold">Description:</span> <span>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima velit sint at. Voluptate atque, excepturi sequi dolorem tempora nesciunt, non iusto ad cum aliquam soluta! Incidunt enim cumque molestiae? Voluptate quam aut quos ab vitae. Numquam nihil sed enim aliquid.</span></p>
                          </div>
                          </div>
  ...
  <!-- ------------------Product-View-Details-Modal-end------------------ -->
            ...
            <!-- Modal -->
            <div class="modal fade" id="product_subcategory_details" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
    ...
    <!-- ------------------Block-User-Modal-start------------------ -->
            ...
            <div class="modal fade" id="deactivate_user" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-footer">
                      <button type="button" onclick="window.location.href='/lab_editor/change_status/{{$user->id}}'" class="btn btn-danger">Deactivate</button>
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                  </div>
              </div>
              </div>
                    ...
                    <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="email" name="email" value="{{$user->email}}" class="form-control" readonly placeholder="xyx@gmail.com">
                                </div>
                                <div class="col-md-6">
  ...
  <!-- ------------------Send-Email-Modal-end------------------ -->
      ...
      <!-- ------------------Edit-Product-Categories-Modal-start------------------ -->
            ...
            <!-- Modal -->
            <div class="modal fade" id="edit_product_category" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
  ...
  <!-- ------------------Edit-Product-Categories-Modal-end------------------ -->
        ...
        <!-- ------------------Product-SubCategories-Edit-Modal-start------------------ -->
            ...
            <!-- Modal -->
            <div class="modal fade" id="edit_product_subcategory" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Product Category</h5>
