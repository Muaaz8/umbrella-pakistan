            ...
            <table class="table table-hover table-responsive tblData Contact" id="">
                ...
                <table>
                    <thead class="p-2">
                            ...
                            <th class="text-center p-2">Terms Of </th>
                    ...
                    @if (is_array($data) || is_object($data))
                        ...
                        <tr>
                            ...
                            <td class="terms-icon">
                                <a href="/terms_of_use/show/{{$dt['id']}}"><i class="fa fa-eye"></i></a>
                                <a href="/terms_of_use/update/{{$dt['id']}}"><i class="fa fa-edit"></i></a>
                                <a href="/terms_of_use/delete/{{ $dt['id'] }}"><i class="fa fa-trash"></i></a>
