...
<form action="">
    ...
    <!-- <br />
    <div class="div-border1 flexrow">
        <div class="width-60  float-left" style="padding-top:16px;">
            <input type="text" name="" id="" class="text-border width-80">
        </div>
        <div class="width-20  float-left">
            <p>
                <input type="text" name="" id="" class="text-border  width-60">
            </p>
        </div>
        <div class="width-20  float-right" style="padding-top:16px;">
            <input type="text" class="text-border  width-60">
        </div>
    </div>
    <br />
    <div class="div-border1 flexrow">
    ...
    <br />
    <!-- <div class=" width-100" style="margin-top:1px">
        <label for="">
            <span class="notes float-left" style="font-size:15px;font-weight:600;height:30px">Notes to pharmacy:</span>
        </label>
        <span style="padding-bottom:16px;"></span>
    </div> -->
    ...
    <div style="display:flex;clear:both;padding-bottom:12px;">
        <div class="div-border float-left" style="width:39.8%;">
            ...
            <span class="data">{{'Dr. '.$items[$first_key]['prescribed_by']}}</span>
        </div>
    ...
    <div class='main-cont flexrow'>
        ...
        <div class='right-cont float-right'>
            ...
            <!-- <div class=" float-left">
                <label>Refills</label>
                <input type="radio" name="refills" value="1" />
                <label for="m">1</label>
                <input type="radio" name="refills" value="2" />
                <label for="f">2</label>
                <input type="radio" name="refills" value="3" />
                <label for="f">3</label>
                <input type="radio" name="refills" value="others" />
                <label for="f">others</label>
            </div>
            <br /> -->
            <!-- <label class="float-left" style="margin-top:2px;font-weight:bold">Dosage:
            </label> -->
            <div class="float-left" style="margin-top:2px;">
                @foreach($items as $item)
                <span class="data">{{$item['name']}}</span>
                <span class="data" style="margin-bottom:1px;">{{$item['medicine_usage']}}</span>
                @endforeach
            </div>

            <div style="height:100px;margin-top:80px">
                <div class="float-left" style="width:50%">
                    <img src="{{$signature}}" height="80">
