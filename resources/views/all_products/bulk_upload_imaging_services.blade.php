        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2>Upload Bulk Imaging Services</small> </h2>
                        ...
                        <div class="body">
                            {!! Form::open(['route' => 'bulkUploadImagingServicesStore', 'files' => true]) !!}
                            <div class="row clearfix">
                                <!-- Service Name -->
                                <div class="form-group col-sm-4">
                                    {!! Form::label('name', 'Service Name:') !!}
                                    <select class="form-control imagingServicesSelect product-input"  multiple="multiple" name="name[]" id="name" required>
                                    </select>
                                </div>

                                <div class="form-group col-sm-4">
                                    <label for="city">Location</label>
                                    <select class="form-control imagingLocationSelect  product-input" name="city"
                                        id="city" required>
                                    </select>
                                </div>
