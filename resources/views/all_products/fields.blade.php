...
<div class="form-group  col-sm-3">
    <label for="name">Select Including Tests</label>
    <select class="form-control testSelect2  product-input " name="including_test[]" multiple="multiple">
    </select>
</div>
<div class="form-group  col-sm-3">
    <label for="parent_category">Choose Panel Category</label>
    <select class="form-control  product-input parent_category_products" name="parent_category[]" multiple="multiple"
        required>
        @if (isset($prefield))
...
<div class="form-group col-sm-3">
    <div class="custom-control custom-checkbox">
        ...
        <label class="custom-control-label" for="is_featured"
            style=" font-size: 18px; position: relative; top: 30px; ">Is Featured</label>
    </div>
    <div class="custom-control custom-checkbox">
...
<div class="form-group  col-sm-3">
    ...
    {!! Form::text('name', null, ['class' => 'form-control product-input']) !!}
</div>
...
<div class="form-group  col-sm-6">
    {!! Form::label('test_details', 'Test Details:') !!}
    {!! Form::textarea('test_details', null, ['class' => 'form-control product-input']) !!}
</div>
<div class="form-group col-sm-6">
    {!! Form::label('short_description', 'Short Description') !!}
    {!! Form::textarea('short_description', null, ['class' => 'form-control product-input']) !!}
</div>

<div class="form-group col-sm-12">
    {!! Form::label('description', 'Description:') !!}
    {!! Form::textarea('description', null, ['class' => 'form-control product-input']) !!}
</div>
...
<div class="form-group col-sm-4">
    ...
    <select class="form-control imagingServicesSelect  product-input" name="name" id="name" required>
        <option selected="selected" value="{{ isset($allProducts) ? $allProducts->product_id : '' }}">
            {{ isset($allProducts) ? $allProducts->product_name : '' }}</option>
    </select>
</div>

<div class="form-group col-sm-4">
    <label for="city">Location</label>
    <select class="form-control imagingLocationSelect  product-input" name="city" id="city" required>
        <option selected="selected" value="{{ isset($allProducts) ? $allProducts->location_id : '' }}">
            {{ isset($allProducts) ? $allProducts->location_name : '' }}</option>
    </select>
</div>
...
<div class="form-group col-sm-4">
    ...
    {!! Form::text('zip_code', null, ['class' => 'form-control product-input ']) !!}
</div>
...
<div class="form-group col-sm-4">
    ...
    <select class="form-control  product-input" name="parent_category" id="parent_category" required>
        <option value="">Select</option>
...
<div class="form-group col-sm-6">
    ...
    <select class="form-control  product-input" name="medicine_type" id="medicine_type">
        <option value="" disabled>Select</option>
        <option value="counter">Counter Medicine</option>
...
<select class="form-control  product-input" name="stock_status" id="stock_status" hidden>
...
<div class="form-group col-sm-6">
    {!! Form::label('short_description', 'Short Description:') !!}
    {!! Form::text('short_description', null, ['class' => 'form-control product-input']) !!}
</div>
...
<div class="form-group d-flex justify-content-center col-sm-12">
    {!! Form::submit('Save', ['class' => 'btn callbtn ']) !!}
    @if (auth()->user()->user_type != 'editor_imaging')
        <a href="{{ route('allProducts.index') }}" class="btn callbtn">Cancel</a>
    @endif
