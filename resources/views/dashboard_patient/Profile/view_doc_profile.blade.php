                          ...
                          <div class="about-doctor">
                                    ...
                                    <div class="d-flex flex-column mb-2">
                                      ...
                                      <span class="subheadings">
                                        <i class="fa fa-circle" style="color:green;"></i> {{$doc->status}}</span>
                                        @else
                                        <span class="subheadings">
                                        <i class="fa fa-circle" style="color:red;"></i> {{$doc->status}}</span>
                                        @endif
                                    </div>
                                    <div class="appoint-btn"><button type="button" class="btn btn-primary" onclick="bookAppointmentModal({{ $doc->id }},{{ auth()->user() }})"> Book Appointment </button>
                                    </div>
