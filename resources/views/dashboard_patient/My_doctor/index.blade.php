                    ...
                    <div class="col-md-4 col-lg-3 col-sm-6 mb-3">
                        <div class="card">
                            <div class="additional">
                                <div class="user-card">
                                    <img src="{{ $doctor->user_image }}" alt="" onclick="window.location.href='/view/doctor/{{$doctor->id}}'" />
                                </div>
                            </div>

                            <div class="general">
                                <h4 onclick="window.location.href='/view/doctor/{{$doctor->id}}'">Dr. {{ucfirst( $doctor->name)." ".ucfirst( $doctor->last_name) }}</h4>
                                ...
                                @endif
                                <div class="appoint-btn"><button type="button" class="btn btn-primary" onclick="window.location.href='/view/doctor/{{\Crypt::encrypt($doctor->id)}}'" > View Profile </button>
                                <button type="button" class="btn btn-primary" onclick="bookAppointmentModal({{ $doctor->id }},{{ auth()->user() }})"> Book Appointment </button>
                              </div>
                            </div>
                        </div>
                    </div>
