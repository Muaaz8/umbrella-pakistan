                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(response.auth == 0){
                            ...
                            $(".CEva").html('<center> Thank you for providing us information. Please proceed ahead.</center> <br> <center> <a href="' + response.route + '" class="btn btn-primary btn-go">Click Here</a> </center>');
            ...
            .listen('loadOnlineDoctor', (e) => {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data=='1')
                        {
                            $('#load_OnlineDoctors').html('<div class="No__SpeC_avai"><p>No Doctors Available in Selected State.</p></div>');
                        }
                        else
                        {
                                    ...
                                    <div class="general">
                                        ...
                                        <div class="appoint-btn">
                                            <button type="button" class="btn btn-primary"
                                                ...
                                                Profile </button>
                                            <button type="button" id="{{ $doctor->id }}" data-doctor="{{ $doctor->id }}" data-specialization="{{ $doctor->specialization }}" type="button" class="btn btn-primary symptomsOpen">
                                                TALK TO DOCTOR
                                            </button>
                  ...
                  <form id="msform">
                    ...
                    <fieldset>
                      <div>
                        ...
                        <div>
                          <i class="loader fa fa-spinner fa-spin d-none" style="font-size: 60px;"></i>
                    ...
                    <fieldset>
                      <div>
                        <div class="text-start conclusions">
                            <i class="conclusion_loader fa fa-spinner fa-spin d-none d-flex justify-content-center" style="font-size: 60px;"></i>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <button type="button" id="change_state_btn" class="state_upd_btn" onclick="change_state()">UPDATE</button>
