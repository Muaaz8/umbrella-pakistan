...
<div class="dashboard-content">
                            ...
                            <div class="general">
                                ...
                                <div class="appoint-btn">
                                    <button type="button" class="btn btn-primary"
                                        ...
                                        View
                                        Profile </button>
                                    <button id="{{ $doctor->id }}" class="btn btn-primary" onclick="inquiryform(this)"
                                        data-price="{{ $doctor->consultation_fee }}">
                                        TALK TO DOCTOR
                                    </button>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="inquiryModal" data-bs-keyboard="false" style="font-weight: normal; " tabindex="-1"
        role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="symp">
                        <small>Please fill this form to continue</small>
                    </h5>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select name="gender"
                                                                ...
                                                                <option value="female" {{ auth()->user()->gender ==
                                                                    'female' ? 'selected' : '' }}>
                                                                    Female </option>
                                                                <option value="other" {{ auth()->user()->gender ==
                                                                    'other' ? 'selected' : '' }}>
                                                                    Other </option>
                                                            </select>
                                                            <small
                                                    ...
                                                    <div class="chat__main__">
                                                        <div class="text-start right__user">
                                                            ...
                                                            <img class="right__user_img" height="30" width="30"
                                                                src="{{ asset('') }}assets/images/doc__.jpg" alt="">
                                                        </div>
                                                    </div>
                                                    <div>
