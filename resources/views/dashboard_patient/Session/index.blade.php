...
<div class="dashboard-content">
    <div class="container-fluid">
      ...
      <div class="row m-auto all-session-wrap">
        <h4>All Sessions</h4>
        <form action="{{ route('patient_session_search') }}" method="post">
            @csrf
            <div class="row">
                    <div class="col-md-5 col-sm-4 mb-2"><input type="search" name="session_id" id="search" class="bg-light form-control" placeholder="Search Here By Session ID(Only Numeric Values)" value=""></div>
                    <div class="col-md-5 col-sm-4 mb-2"><input type="text" name="datefilter" id="datePick" class="bg-light form-control" placeholder="Filter Session Record By Date-Range" value=""></div>
                    <div class="col-md-2 col-sm-4 mb-2"><button type="submit" class="btn medi-search">Search</button></div>
            </div>
        </form>
        ...
        <div class="text-center for-empty-div">
            ...
            <h6> No Session Records </h6>
        </div>
        @endforelse
        <div>{{ $sessions->links('pagination::bootstrap-4') }}</div>
      </div>
    </div>
  </div>
