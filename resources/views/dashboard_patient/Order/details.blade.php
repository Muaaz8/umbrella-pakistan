        ...
        <div class="col-md-6">
          <div class="card" style="width: 100%">
            <ul class="list-group list-group-flush">
                ...
                @endif
              <li class="list-group-item d-flex justify-content-between"><b>Payment Type :</b>{{ $data['order_data']->payment_title }} </li>
            </ul>
          </div>
        </div>
                ...
                <div class="payment-order-summary-wrap">
                  <div class="card">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            Provider Fee <span>${{ $providerfee }}</span>
                        </li>
                        <li class="list-group-item">
                            To be Paid <span>${{ (float)$priceTotal+(float)$data['order_data']->total_tax+(float)$providerfee }}</span>
                        </li>
                    </ul>
                  </div>
                </div>
                        ...
                        <div class="col-md-6 mb-2">
                            <div class="card" style="width: 100%">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item"><b>Phone :</b> {{  explode('|', $data['billing'][10])[1] }}</li>
