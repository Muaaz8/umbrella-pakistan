          ...
          <div class="container-fluid">
            <div class="col-md-12">
              ...
              <div>
                    ...
                    {{--<h3 class="spec__loCation" style="cursor:pointer;"><i class="fa-solid fa-location-dot"></i> {{$state->name}} <i class="fa-solid fa-sort-down pt-1"></i></h3>--}}
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <!-- <form id="search_form" action="/book/appointment/{{$id}}/{{$loc_id}}" method="POST">
                            ...
                            <button type="submit" class="btn process-pay"><i class="fa-solid fa-search"></i></button>
                            </div>
                        </form> -->
                    </div>
                </div>
