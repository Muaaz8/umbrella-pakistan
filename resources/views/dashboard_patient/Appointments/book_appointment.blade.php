                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(response.auth == 0){
                            ...
                            $(".CEva").html('<center> Thank you for providing us information. Please proceed ahead.</center> <br> <center> <a href="#" class="btn btn-primary btn-go" onclick="bookAppointmentModal(' +response.doc_id + ')">Click Here</a> </center>');
    ...
    function change_state()
        {
            ...
            $.ajax({
                ...
                success: function(data) {
                  if(data == '1')
                  {
                    $('#load_docs').html('<div class="No__SpeC_avai"><p>No Doctors Available in Selected State.</p></div>');
                    $('.spec__loCation').html('<div class="d-flex align-items-center state___sty spec__loCation">'
                        +'<p id="selected_state">'+name+'</p><i class="fa-solid fa-sort-down pb-1"></i></div>');
        ...
        <div class="col-md-12">
            <div class="row m-auto all-doc-wrap">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        @if($id==21)
                        <form id="search_form" action="/psych/book/appointment/{{$id}}/{{$loc_id}}" method="POST">
                            @csrf
                            <div class="input-group">
                                <input type="hidden" name="spec_id" id="search_spec">
                                <input type="hidden" name="loc_id" id="search_loc">
                                <input type="text" id="search" name="name" class="form-control" placeholder="Search"
                        ...
                        @else
                        <form id="search_form" action="/book/appointment/{{$id}}/{{$loc_id}}" method="POST">
                            @csrf
                            <div class="input-group">
                                <input type="hidden" name="spec_id" id="search_spec">
                                <input type="hidden" name="loc_id" id="search_loc">
                            ...
                            <div class="general">
                                ...
                                <div class="appoint-btn"><button type="button" class="btn btn-primary"
                                    ...
                                    <button type="button" class="btn btn-primary symptomsOpen"
                                        id="{{ $doc->id }}" data-user="{{ $user }}" data-doctor="{{ $doc->id }}" data-specialization="{{ $doc->specialization }}">
                                        Book Appointment
                                    </button>
                                </div>
                            </div>
            ...
            <div class="modal-body">
                <div class="p-4 text-center update_location_main">
                    ...
                    <select id="location_id" class="form-select update_select" aria-label="Default select example">
                        ...
                        @if($loc->id == $loc_id)
                        <option id="opt_{{$loc->id}}" value="{{$loc->id}}" selected>{{$loc->name}}</option>
                        @else
                        <option id="opt_{{$loc->id}}" value="{{$loc->id}}">{{$loc->name}}</option>
                        @endif
                        @endforeach
                    </select>
                      ...
                      <div class="form-card">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            @endphp
                            <input class="custom_input symptom_checker_age age" type="age" name="text" placeholder="Please enter your age" value="{{ $age }}" required/>
                      ...
                      <div>
                        <div class="chat__main__">
                          <div class="text-start right__user">
                            ...
                            <img class="right__user_img" height="30" width="30" src="{{ asset('') }}assets/images/doc__.jpg"
                              alt="">
                          </div>
                        </div>
                        <div>
                          <i class="loader fa fa-spinner fa-spin d-none" style="font-size:35px;"></i>
                    ...
                    <fieldset>
                      <div>
                        <div class="text-start conclusions">
                            <i class="conclusion_loader fa fa-spinner fa-spin d-none d-flex justify-content-center" style="font-size:35px;"></i>
