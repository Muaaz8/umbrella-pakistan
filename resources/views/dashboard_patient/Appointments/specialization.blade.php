...
<script type="text/javascript">
    ...
    function spec_redirect(spec_id)
    {
        ...
        if(spec_id!="" && loc_id!="")
        {
            window.location.href="/book/appointment/"+spec_id+"/"+loc_id+"";
        }
    }
     ...
     <div class="container-fluid">
        <!-- <div class="row"> -->
            <div class="row my-2 m-auto">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <div class="d-flex select__main_state">
                                    ...
                                    <div class="d-flex align-items-center state___sty" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
              ...
              <!-- <div><button class="location__back__BTN" onclick="window.location.href='{{url()->previous()}}'"><i class="fa-solid fa-arrow-left"></i> Back</button></div>
                    <h3 class="spec__loCation"><i class="fa-solid fa-location-dot"></i> {{$state->name}}</h3> -->
