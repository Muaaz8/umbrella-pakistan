...
@section('page_title')
    <title>UHCS - Appointment Payment</title>
@endsection
...
@section('bottom_import_file')
    <script>
        ...
        // function checkRadio(parentDiv) {
        //     var radioBtn = parentDiv.querySelector('input[type="radio"]');
        //     radioBtn.checked = true;
        //     radioClick(e);
        // }
        // function radioClick(radioBtn) {
        //     radioClick(e);
        // }
    </script>
        ...
        <div class="col-11 m-auto">
            <div class="row">
                    ...
                    <div class="col-md-12 mb-3 px-md-2 p-0 ">
                        <div class="col-md-12 mb-2">
                            @foreach ($cards as $card)
                                <div class="d-flex align-items-center mb-2 justify-content-between api_saved_card" data-card="{{ $card->id }}"  onclick="divClick(this)">
                                    ...
                                    <div class="checkb-round">
                                        <input type="radio" onclick="radioClick(this)" data-card="{{ $card->id }}"
                                            name="card" id="{{ $card->card_type }}" />
                ...
                <div class="col-md-12 mb-3 px-md-2 p-0 ">
                    @if (count($cards) != 0)
                        <div class="col-md-8 mb-3">
                            <button id="addButton" onclick="addCard()" class="btn process-pay" style="width:100%">Add New
                                Card</button>
                        </div>
                    @endif
                </div>
                ...
                <div class="account-setting-wrapper pay-image bg-white">
                    ...
                    <form action="{{ route('payment_appointment1') }}" method="post" id="payment-form-old">
                        @csrf
                        <input type="hidden" name="old_card" value="yes">
                        <input type="hidden" name="session_id" value="{{ old('session_id') ?? $session_id }}">
                        <input type="hidden" name="amount_charge" value="{{ $price }}">
                        <input type="hidden" name="card_no" id="card_no" value="">
                        <div class="py-3 pb-4" id="buttondiv">
                            <button type="submit" id="pay_submit1" class="btn process-pay mr-3">PROCESS PAYMENT</button>
                        </div>
                    </form>
                </div>
            </div>
            <div class="div1" style="display: none;">
                <div class="account-setting-wrapper pay-image bg-white" style="padding: 15px 25px;">
                    ...
                    <form action="{{ route('payment_appointment1') }}" method="post" id="payment-form">
                        @csrf
                        <div class="py-2">
                            <div class="row py-2">
                                ...
                                <div class="col-md-6 pt-md-0 pt-3 mb-2">
                            ...
                            <div class="row py-2">
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="email" id="email" class="bg-light form-control"
                                ...
                                <div class="col-md-4 mb-2">
                                    ...
                                    <input type="text" name="card_num" id="card_num" class="bg-light form-control"
                                        value="" placeholder="1234-2345-3445-2324" maxlength="19" onkeyup="addHyphen(this)" required>
                                </div>
                                </div>
                            <div class="row py-2">
                                <div class="col-md-4">
                                    <label for="Expirationmonth">Expiration Month</label>
                                    <select class="form-select" name="month" id="month" value="" required>
                                ...
                                <div class="col-md-4 pt-md-0 pt-3">
                                    ...
                                    <input type="text" name="cvc" id="cvc" class="bg-light form-control"
                                        maxlength="4" required value="" placeholder="Enter CVV/CVC" required>
                                </div>
                            ...
                            <div class="row py-2">
                                <div class="col-md-4 pt-md-0 pt-3">
                                    ...
                                    <input type="tel" class="bg-light form-control" id="zipcode" name="zipcode"
                                        oninput="myFunction()" class="form-control m-0" maxlength="6"
                                        placeholder="Add Zipcode" value="" required>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row py-2">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="address" name="address" class="bg-light form-control"
                                        maxlength="60" value="" placeholder="Enter Your Address" required>
