...
@section('page_title')
    <title>UHCS - Therapy Event Payment</title>
@endsection
        ...
        <div class="col-11 m-auto">
            <div class="row">
                            ...
                            @foreach ($cards as $card)
                                <div class="d-flex align-items-center mb-2 justify-content-between api_saved_card">
                                    ...
                                    <div class="checkb-round">
                                        <input type="radio" onclick="radioClick(this)" class="{{ $card->id }}"
                ...
                <div class="account-setting-wrapper pay-image bg-white">
                    ...
                    <form action="{{ route('payment_therapy') }}" method="post" id="payment-form-old">
                        @csrf
                        ...
                        <div class="col-md-3">
                            <label for="nick_name_old">Set Nick Name for Confidentiality</label>
                            <input type="text" name="nick_name" id="nick_name_old"
                                class="bg-light form-control" maxlength="30"
            ...
            <div class="div1" style="display: none;">
                <div class="account-setting-wrapper pay-image bg-white" style="padding: 15px 25px;">
                    ...
                    <form action="{{ route('payment_therapy') }}" method="post" id="payment-form">
                        @csrf
                        <div class="py-2">
                            <div class="row py-2">
                            ...
                            <div class="row py-2">
                                <div class="col-md-3">
                                    <label for="nick_name">Set Nick Name for Confidentiality</label>
