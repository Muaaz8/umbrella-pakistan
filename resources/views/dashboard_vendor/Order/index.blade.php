    ...
    <div class="row m-auto">
      ...
      <div class="row m-auto">
        ...
        <div class="p-0">
          ...
          <input type="text" id="search" class="form-control" placeholder="Search" aria-label="Username"
      ...
      @endphp
        ...
        @endif
          ...
          <a href="{{ route('vendor_order_details', ['id' => $order->id]) }}" class="orders-view-btn">
            View
          </a>
          </td>
          </tr>
