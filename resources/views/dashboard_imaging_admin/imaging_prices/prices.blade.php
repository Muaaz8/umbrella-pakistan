                            ...
                            @forelse($prices as $price)
                              <tr>
                                ...
                                <td data-label="Actions">
                                    <button class="btn btn-primary mb-1" href="#" onclick="edit_img_pr({{$price->id}})">Edit</button>
                                    <button class="btn btn-danger mb-1" href="#" onclick="del_img_pr({{$price->id}})">Delete</button>
                                </td>
                              </tr>
                              @empty
                              <tr>
