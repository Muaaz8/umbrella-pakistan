        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-lg-12 text-center p-5">
                    <img src="https://demo.umbrellamd-video.com/asset_frontend/images/logo.png" style="height:200px; width:200px;" alt="">
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
...
<p>Last Revised: {{ $revised }}</p>

<p>This website (&ldquo;www.umbrellamd.com&rdquo;) is owned and operated by Umbrella Health Care Systems (&ldquo;Umbrella,&rdquo; &ldquo;we,&rdquo; &ldquo;our,&rdquo; or &ldquo;us&rdquo;). The Site connects users with healthcare providers for virtual telehealth services and provides telemedicine solutions to users including access to pharmacy, laboratory testing, imaging, substance abuse, and dermatology services (the &ldquo;Services&rdquo;).&nbsp;</p>

<p>UMBRELLA IS NOT INTENDED TO PROVIDE MEDICAL ADVICE, DIAGNOSIS, OR SUGGESTIONS FOR TREATMENT. YOU CONTACT YOUR PHYSICIAN OR OTHER HEALTHCARE PROFESSIONAL CONCERNING YOUR PARTICULAR MEDICAL CONDITION OR CONCERNS. DO NOT DISREGARD PROFESSIONAL MEDICAL ADVICE, OR DELAY IN SEEKING IT BECAUSE OF SOMETHING YOU READ ON UMBRELLA.&nbsp;</p>

<p>PLEASE DO NOT ATTEMPT TO COMMUNICATE WITH US ABOUT YOUR SPECIFIC MEDICAL CONDITION, EVEN IN AN EMERGENCY, THROUGH UMBRELLA. WE DO NOT MONITOR YOUR COMMUNICATIONS TO US THROUGH THE SITE FOR THESE PURPOSES, AND WE MAY NOT RESPOND TO YOUR COMMUNICATION IN AN APPROPRIATE TIMEFRAME. CONTACT YOUR PHYSICIAN OR HEALTHCARE PROFESSIONAL FOR ADVICE CONCERNING YOUR MEDICAL NEEDS OR CONTACT YOUR LOCAL EMERGENCY SERVICES IN CASE OF AN EMERGENCY. &nbsp;<br />
...
<p><strong>MANDATORY ARBITRATION NOTICE AND CLASS ACTION AND JURY TRIAL WAIVER.</strong> These Terms contain a mandatory (binding) arbitration provision and class action and jury trial waiver clauses. Except for certain types of disputes described in the arbitration section below or where prohibited by applicable law, you agree that disputes between you and us regarding your use of the Site or Services will be resolved by binding, individual arbitration and you waive your right to participate in a class action lawsuit or class-wide arbitration, including as a class representative. The arbitrator&rsquo;s decision will be subject to very limited review by a court. You will be entitled to a fair hearing, but the arbitration procedures are simpler and more limited than rules applicable in Court. For more details, see below.<br />
...
<p>In addition to these Terms, your use of certain Services may be governed by additional agreements.</p>

<p>Besides these Terms, we also publish a Privacy Policy [hyperlink]. Although it is not part of these Terms, we encourage you to read it to better understand how you can update, manage, access, and delete your information.</p>

<p>&nbsp;</p>

<ul>
	<li><strong>Accessing the Site</strong><br />
	...
	You are responsible for both:</li>
...
<p>To access the Site or certain of the resources it offers, you may be asked to provide certain registration details or other information. It is a condition of your use of the Site that all the information you provide on the Site is correct, current, and complete, and that you have the authority to provide such information to us.&nbsp;<br />
...
We have the right to disable any username, password, or other identifier, whether chosen by you or provided by us, at any time in our sole discretion for any reason, including if, in our opinion, you have violated any provision of these Terms.</p>

<ul>
	<li><strong>Our Role</strong></li>
</ul>

<p>Healthcare providers contracted with Umbrella (&ldquo;Providers&rdquo;) provide consultations and services through telecommunication technologies. The Provider conducting the consultation determines the scope of services for diagnosis, treatment, and care.&nbsp;</p>

<p>Our role is limited to making certain telehealth related information available to you and helping facilitate your access to telemedicine and medical services. Umbrella is independent from Providers and is not responsible for such Providers&rsquo; acts, communications, or any content provided by them.&nbsp;</p>

<p>We do not engage in the practice of medicine. We do not provide medical advice. The decision to follow treatment recommendations rests with you and your Provider. By accessing, using, or browsing the Site or Services or providing medical history, you do not create a physician-patient or healthcare provider-patient relationship between you and Umbrella or any of our employees and/or affiliates. Any Services provided by us, or content accessed by you on the Site are for informational purposes only and are not intended to replace the advice of your healthcare provider. Please consult your doctor or other qualified healthcare provider if you have any questions about a medical condition. Call 911 for all medical emergencies. UMBRELLA IS NOT RESPONSIBLE OR LIABLE FOR ANY ADVICE, COURSE OF TREATMENT, DIAGNOSIS OR ANY OTHER INFORMATION, SERVICES OR PRODUCTS THAT YOU MAY OBTAIN THROUGH THE SITE.&nbsp;</p>

<p>The information presented on or through the Site is made available solely for general information purposes. The information provided does not constitute medical advice or counsel. We do not warrant the accuracy, completeness, or usefulness of this information. Any reliance you place on such information is strictly at your own risk. We disclaim all liability and responsibility arising from any reliance placed on such materials by you or any other visitor to the Site, or by anyone who may be informed of any of its contents.<br />
...
<ul>
	<li><strong>Proprietary Rights and Your Use of the Site</strong></li>
</ul>

<p>Unless otherwise specified in these Terms, all information and screens appearing on this Site are the sole property of Umbrella or our subsidiaries and affiliates, and other parties. We provide content through the Site that is copyrighted or contains protectable trademarks of Umbrella or our third-party licensors and suppliers (collectively, the &ldquo;Materials&rdquo;). Materials may include documents, services, software, site design, text, graphics, logos, video, images, icons, and other content, as well as the arrangement thereof.&nbsp;<br />
...
If you breach any of these Terms, the above license will terminate automatically and you must immediately destroy any downloaded or printed Materials.</p>

<ul>
	<li><strong>Your Communications to the Site</strong></li>
</ul>
...
<ul>
	<li><strong>Linking to the Site and Social Media Features</strong></li>
</ul>

<p>You may link to our Site, provided you do so in a way that is fair and legal and does not damage our reputation or take advantage of it, but you must not establish a link in such a way as to suggest any form of association, approval, or endorsement on our part without our express written consent.&nbsp;<br />
This Site may provide certain social media features that enable you to:</p>
...
<p>The website from which you are linking, or on which you make certain content accessible, must comply in all respects with these Terms.<br />
...
We may disable all or any social media features and any links at any time in our sole discretion and without notice.&nbsp;</p>

<ul>
	<li><strong>Federal and State Laws&nbsp;</strong></li>
</ul>
...
<ul>
	<li><strong>Minimum Age</strong></li>
</ul>
...
BY PROVIDING THE SERVICES ON THE SITE, WE DO NOT IN ANY WAY PROMISE THAT THE SERVICES WILL REMAIN AVAILABLE TO YOU. WE ARE ENTITLED TO TERMINATE ALL OR PART OF ANY OF THE SITE AT ANY TIME, IN OUR SOLE DISCRETION WITHOUT NOTICE TO YOU.</p>
...
<p>Umbrella respects the intellectual property of others. If you believe that your work has been copied in a way that constitutes copyright infringement, please contact us through the contact information provided in these Terms.</p>
...
<ul>
	<li><strong>MANDATORY ARBITRATION AND CLASS ACTION AND JURY TRIAL WAIVER.</strong></li>
</ul>

<p>Most concerns can be resolved quickly and to your satisfaction by contacting us as set forth in the &ldquo;Questions&rdquo; section below.<br />
...
<p><br />
<strong>You may reject this arbitration provision within thirty (30) days of accepting the Terms by emailing us at _____________________ and including in the subject line &ldquo;Rejection of Arbitration Provision.&rdquo;</strong></p>
...
<p><strong><em>Governing Law and Venue.</em></strong> These Terms shall be governed by and construed in accordance with the laws of the State of Missouri, excluding its conflicts of law rules, and the United States of America. Except as set forth in the agreement to arbitration and without waiving it, you agree that any dispute arising from or relating to the subject matter of these Terms (including but not limited to if you opt out of the agreement to arbitration) shall be governed by the exclusive jurisdiction and venue of the state and federal courts of St. Louis, Missouri, except where the jurisdiction and venue are mandated by applicable assignment.&nbsp;</p>

<p><strong><em>Assignment</em></strong>. We may freely assign our obligations and rights under these Terms, including all personal information in our possession that we have collected during your use of the Site as further described in our Privacy Policy [hyperlink].</p>

<p><strong><em>No Waiver.</em></strong> ​No failure, omission or delay on the part of Umbrella in exercising any right under these Terms will preclude any other further exercise of that right or other right under these Terms.</p>

<p><strong><em>Headings</em></strong>. Provision and section headings are for convenience of reference only and shall not affect the interpretation of these Terms.</p>

<p><strong><em>Typographical Errors.</em></strong> Information on the Site may contain technical inaccuracies or typographical errors. We attempt to make the Site&rsquo;s postings as accurate as possible, but we do not warrant the content of the Site is accurate, complete, reliable, current, or error-free.&nbsp;</p>

<ul>
	<li><strong>Questions</strong></li>
</ul>

<p>If you have any questions or comments about these Terms or this Site, please contact us by email at <strong>legal@umbrellamd.com</strong><br />
<br />
You also may write to us at:&nbsp;</p>

<p><strong>Umbrella Health Care Systems<br />
Attn: Abdul Hadi<br />
625 School House<br />
Road #2, Lakeland, FL 33813<br />
ahadi@umbrellamd.com</strong></p>
