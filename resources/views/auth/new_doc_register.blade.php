...
<style>
    ...
    .main_reg_box .form-control,
    .main_reg_box .form-select {
        border-radius: 30px;
            ...
            <div class="main_reg_box">
                ...
                <form id="doc_reg_form" method="POST" enctype="multipart/form-data" action="javascript:void(0)">
                    <input type="hidden" name="url_type"
                        value="{{ isset($_GET['url_type']) ? $_GET['url_type'] : '' }}" />
                    ...
                    <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" max="<?php echo date(" Y-m-d"); ?>"
                                        maxlength='10' onkeyup="addHyphen(this)" name="date_of_birth" id="date_of_birth"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" name="phone_number" id="phone_number"
                                            maxlength="10" placeholder="(407) 693-8484">
                        ...
                        <h5 class="patient_det_head mb-2 mt-2">Consultation Fee:</h5>
                        <div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="mb-1">
                                        ...
                                        <small class="text-danger" id="consultation_fee_error"></small>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="my-3">
                                        <label for="follow_up_fee_switch" class="form-label">Include Follow-Up Fee:
                                            <span data-toggle="tooltip" data-placement="top"
                                                title="This fee is charged for additional consultations or follow-up visits after the initial consultation.">
                                                <i class="fas fa-info-circle" style="cursor: pointer;"></i>
                                            </span>
                                        </label>
                                        <div class="form-check form-switch">
                                            <input style="width: 3rem;height: 1.5rem;font-size: 1.25rem;" class="form-check-input" type="checkbox" id="follow_up_fee_switch">
                                            <label class="form-check-label" for="follow_up_fee_switch"></label>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div id="follow_up_fee_container" style="display: none;">
                                        <div class="mb-1">
                                            <label for="follow_up_fee" class="form-label">Follow Up Fee:</label>
                                            <input type="number" class="form-control" name="follow_up_fee"
                                                id="follow_up_fee" placeholder="Follow Up Fee">
                                            <small class="text-danger" id="follow_up_fee_error"></small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" name="npi" id="npi"
                                            placeholder="PMDC Registration Number" maxlength="10">
                                ...
                                {{--<div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" name="upin" id="upin"
                                            placeholder="UPIN(Optional).">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select" aria-label="Default select example"
                                            ...
                                            <option value="{{ $spec->id }}" {{ old('specialization')==$spec->id ?
                                ...
                                {{--<div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <select class="form-select mb-3 form-control select2 select2-hidden-accessible"
                                            multiple="" id="licensed_states" name="licensed_states[]"
                                            data-placeholder="Select a State" style="width: 100%; margin:0; "
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <input type="password" class="form-control abcd" name="password"
                                            placeholder="Password" id="password" maxlength="16" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-1">
                                        ...
                                        <div class="position-relative">
                                            <input type="password" class="form-control abcd"
                                                name="password_confirmation" placeholder="Confirm Password"
                                                id="password_confirmation" maxlength="16" />
                                            <i class="fa-solid fa-eye-slash eye__pass_ toggle-password" toggle=".abcd"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="signature_btns">
                                                        <button type="button" class="signature_btns_styles"
                                                            onclick="javascript:void(0)" id="clearBtn">Retake
                                                            Signature</button>
                                                        <button type="button" class="signature_btns_styles"
                                                            onclick="javascript:void(0)" id="btnSave">Save
                                                            Signature</button>
                                                    </div>
                                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check mb-1">
                                        <input class="form-check-input" type="checkbox" id="term" name="terms_and_cond"
                                            value="0">
                                ...
                                <div class="col-md-6 mt-1 mt-md-4">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <button type="button" class="btn"><i onclick="refresh_recaptcha()"
                                                class="ms-2 fa fa-rotate-right" aria-hidden="true"
                                ...
                                <div class="col-md-12 mt-2">
                                    <div class="text-center">
                                        <p>Are you already register? <a href="{{ route('login') }}"><span
                                                    class="login__Span_re">Login</span></a></p>
                                    </div>
                                </div>
...
<script>
    ...
    const followUpSwitch = document.getElementById('follow_up_fee_switch');
    const followUpFeeContainer = document.getElementById('follow_up_fee_container');

    followUpSwitch.addEventListener('change', function() {
        if (followUpSwitch.checked) {
            followUpFeeContainer.style.display = 'block';
        } else {
            followUpFeeContainer.style.display = 'none';
        }
    });
