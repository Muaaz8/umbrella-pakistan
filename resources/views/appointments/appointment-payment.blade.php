			...
			<div class="col-md-8 offset-md-2 col-sm-12 col-xs-12">
                ...
                @endif
                    <div class="card-block">
                        <form action="{{route('appointment_payment')}}" method="post" onsubmit='disableButton()'>
                        @csrf
                        ...
                        <!-- <center> -->
                            {{-- change here price input value when go to live --}}
                        <input type="hidden" name="session_id" value="{{ old('session_id') ?? $session_id }}">
                        <input type="hidden" name="amount_charge" value="{{ old('amount_charge') ?? '1.02' }}">
                        <input type="hidden" name="subject" value="{{ old('subject') ?? 'Appointment' }}">
