...
<div class="dashboard-nav" id="style-10">
      <div class="nav-info-div-wrapper">
        ...
        <h5 class="text-center py-2">Imaging Admin Dashboard</h5>
        <div class="d-flex">
        </div>
      </div>
      <nav class="dashboard-nav-list">
        <a href="/imaging/admin/dash" class="dashboard-nav-item"><i class="fa-solid fa-house"></i> Dashboard </a>


        <a href="/imaging/all/records" class="dashboard-nav-item"><i class="fa-solid fa-gear"></i>All Records</a>
        <a href="/imaging/lab/services" class="dashboard-nav-item"><i class="fa-solid fa-gear"></i>Services</a>
        ...
        <a href="/imaging/lab/order/file" class="dashboard-nav-item"><i class="fa-solid fa-square-plus"></i>Imaging File</a>
        ...
        <a href="/imaging/admin/account/setting" class="dashboard-nav-item"><i class="fa-solid fa-gear"></i>Account Setting </a>
                    ...
                    <div class="profile">
                        ...
                        <div class="dropdown-content">
                            <ul>
                                ...
                                <li onclick="window.location.href='/imaging/admin/account/setting'"><i
