...
<script>
        ...
        function select_doc(value) {
            $.ajax({
                ...
                beforeSend: function() {
                    ...
                    $(".doctor-cont2").html(
                        '<div class="d-flex flex-col align-items-center justify-content-center h-100"><i class="fa fa-spin fa-spinner fs-1"></i> </div>'
                    );
                },
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            <div class="d-flex gap-3">
                                                <div class="d-flex flex-column align-items-center">
                                                    <div class="position-relative bg-white doc-new-profile rounded-4">
                                                        <img class="object-fit-cover rounded-4 w-100 h-100"
                                                            src="${element.user_image}" alt="" />
                                                        <span class="new-indicator ${element.status == 'online' ? 'bg-green' : 'bg-new-red'}"></span>
                                                    </div>
                                                    <div class="d-flex align-items-center gap-2 mt-3">
                                                        <span class="${element.status == 'offline' ? 'text-new-red fw-medium' : 'text-secondary'} fw-medium fs-14">Offline</span>
                                                        <span class="vertical-stick"></span>
                                                        <span class="${element.status == 'online' ? 'text-green fw-medium' : 'text-secondary'} fs-14">Online</span>
                                                    </div>
                                                </div>
                                                <div class="w-100">
                                                    <div class="card-header px-0 bg-transparent border-0 w-100">
                                                        ...
                                                        ${element.consultation_fee ? `<h6 class="fs-14 fw-normal mt-2">
                                                                        Consultation Fee:
                                                                        <span class="text-green fw-semibold">Rs. ${element.consultation_fee}</span>
                                                                    </h6>` : ''}
                                                        ${element.followup_fee && element.followup_fee != element.consultation_fee ? `<h6 class="fs-14 fw-normal mt-2">
                                                                        Follow-Up Fee:
    ...
    : ''
                                                ...
                                                <button
                                                    ...
                                                    <span class="d-flex align-items-center justify-content-center text-center new-arrow-icon-2 bg-blue rounded-circle text-white border-white border-2">
                                                        <i class="fs-14 fa-solid fa-arrow-right"></i>
                                                    </span>
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="w-100">
                                    <div class="card-header px-0 bg-transparent border-0 w-100">
                                        ...
                                        <h6 class="fs-14 fw-normal mt-2">
                                            Consultation Fee:
                                            <span class="text-green fw-semibold">Rs.
                                        ...
                                        <h6 class="fs-14 fw-normal mt-2">
                                            Follow-Up Fee:
                                            <span class="text-blue fw-semibold">Rs.
                                                {{ $doctor->followup_fee }}</span>
                                        </h6>
                                        @endif
                                        @endif
                                    </div>
