...
<script>
    ...
    //         if (e.session_id == "{{ $session->id }}" && e.pat_id!= "") {
    ...
    const joincalls = async function join() {
        //aquire_start();
        // Add an event listener to play remote tracks when remote user publishes.
        client.on("user-published", handleUserPublished);
        client.on("user-unpublished", handleUserUnpublished);
    ...
    var appid = "{{ env('AGORA_APP_ID') }}";
    var channel = "{{$session->channel}}";
    var uid = "{{$session->users}}_{{$session->name}}";
    var token = '';
        ...
        <div class="col-12">
          <div class="call-screen-header">
            <div class="d-flex align-items-center">
              ...
              <h6>Host Joining Link: {{env('APP_URL')}}/host/join/video/{{$session->id}}</h6>
              
            </div>
            <div class="call-time">
            <h6>Guest Joining Link: {{env('APP_URL')}}/guest/join/video/{{$session->id}}</h6>
        ...
        <div class="row m-0 align-items-center">
          ...
          <div class="col-lg-6">
            <div class="video-iconss">
              ...
              <i id="inItScreen" class="">Share Screen</i>

            </div>
          </div>
          <div class="col-lg-3">
            <div class="multiple__options d-flex justify-content-end">
              <i class="fa-solid fa-users" onclick="openNav()"></i>
            </div>
          </div>
        </div>
      </div>
      <div id="mySidenav" class="sidenav">
      <h5 class="users__headi">PARTICIPANTS</h5>
