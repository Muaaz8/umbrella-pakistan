...
@section('content')
  ...
  <main class="w-100">
    <section class="w-100 flex align-items-center justify-content-center">
      <div
        class="hero-section-doctor flex align-items-center justify-content-center"
      >
        <div
    ...
    <section class="w-100 d-flex align-items-center justify-content-center">
      <div
        class="specialization-section fw-bold d-flex align-items-center justify-content-center flex-column my-3"
      >
        <div class="specialization-container d-flex flex-column gap-4">
          ...
          <div class="row g-4">
            <div class="col-sm-6 col-xl-3">
              <div
                class="specialized-column ps-4 pt-4 d-flex flex-column gap-1 shadow rounded-3"
              >
                ...
                <div
                  class="d-flex align-content-center justify-content-end specialized-icons"
                >
    ...
    <section class="w-100 d-flex align-items-center justify-content-center">
      ...
      >
        <div class="specialization-container d-flex flex-column gap-4">
          ...
          <div class="row g-4">
            <div class="d-flex gap-2 col-12 col-md-6 col-lg-4">
              <div
                class="work-column w-100 d-flex gap-1 align-items-center shadow-sm rounded-3"
              >
                <div
                  class="d-flex align-items-center justify-content-center work-icons"
                >
            ...
            <div class="d-flex gap-2 col-12 col-md-6 mx-md-auto col-lg-4">
              <div
