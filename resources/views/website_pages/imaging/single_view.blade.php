...
@section('page_title')
    ...
    @else
        <title>{{$products[0]->name}} | Imaging | Umbrella Health Care Systems</title>
    @endif
@endsection
...
@section('content')
    ...
    <section class="detail-pharmacy-bg">
        <div class="container">
          ...
          <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('imaging') }}">Medical Imaging</a></li>
  ...
  <div class="container">
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap">
      <h5 class="text-danger">Prescription Required for this Service</h5>
