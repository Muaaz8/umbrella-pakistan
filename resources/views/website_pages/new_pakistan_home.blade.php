            ...
            <div class="row gy-3 gx-0 g-sm-4 w-85">
                    ...
                    <div id="mainBanner" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-3">
                            <div class="carousel-item active">
                                <img src="{{ asset('assets/new_frontend/new-banner.webp') }}" class="d-block w-100"
                                    alt="..." />
                            </div>
                ...
                <div class="pe-md-0 col-md-4">
                    <div
                        ...
                        <img class="w-75 w-sm-50 w-md-100" src="{{ asset('assets/new_frontend/dr-essa-logo.webp') }}"
                            alt="" />
                    </div>
                </div>
                <div class="ps-md-0 col-md-4">
                    <div
                        class="w-100 d-flex align-items-stretch justify-content-between service-card p-3 p-sm-4 rounded-3 h-100">
                        <div class="w-60 card-text-cont">
                            ...
                            <a @if (Auth::check()) href="{{ route('patient_evisit_specialization') }}" @else data-bs-toggle="modal" data-bs-target="#loginModal" @endif
                        ...
                        <div class="d-flex align-items-end justify-content-center w-40">
                            <img class="w-100 h-100 object-fit-contain"
                                src="{{ asset('assets/new_frontend/e-visit-img.png') }}" alt="" />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="w-60 card-text-cont">
                            ...
                            <a href="{{ route('vendor', ['shop_type' => 'pharmacy']) }}"
                                class="card-btn bg-green d-flex align-items-center gap-2 my-3 px-3 py-1 rounded-2 text-white fs-12"><span
                                    class="fw-semibold">Visit our Store</span><i
                                    class="fa-solid fa-arrow-right fs-14"></i></a>
                        </div>
                        <div class="d-flex align-items-end justify-content-center w-40 ps-2">
                            <img class="w-100 h-100 object-fit-contain"
                                src="{{ asset('assets/new_frontend/tab-cart.png') }}" alt="" />
                        </div>
                    </div>
                </div>
                <div class="pe-md-0 col-md-4">
                    <div class="w-100 d-flex align-items-stretch justify-content-between service-card rounded-3 h-100">
                        ...
                        <div class="d-flex align-items-end justify-content-center w-40 pe-3 pe-sm-4">
                            <img class="w-100 h-100 object-fit-contain" src="{{ asset('assets/new_frontend/person.png') }}"
                                alt="" />
                        </div>
                    </div>
                </div>
        ...
        <section
            ...
            <div class="bg-light-blue rounded-3 pt-3 pb-2 px-2 w-85">
                ...
                <div class="d-none d-sm-block">
                    <ul class="nav justify-content-center nav-pills my-3 bg-white p-2 rounded-2" id="pills-tab"
                        role="tablist">
                        <li class="nav-item px-4" role="presentation">
                            <button class="text-navy-blue py-2 px-4 fw-semibold nav-link active"
                                id="pills-register-patient-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-register-patient" type="button" role="tab"
              ...
              Register as a Doctor
                        ...
                        <li class="nav-item px-4" role="presentation">
                            <button class="text-navy-blue py-2 px-4 fw-semibold nav-link" id="pills-order-medicine-tab"
                                data-bs-toggle="pill" data-bs-target="#pills-order-medicine" type="button"
                                role="tab" aria-controls="pills-order-medicine" aria-selected="false">
                                Order Medicine
                            </button>
                        </li>
                        <li class="nav-item px-4" role="presentation">
                            <button class="text-navy-blue py-2 px-4 fw-semibold nav-link" id="pills-order-lab-tab"
                                data-bs-toggle="pill" data-bs-target="#pills-order-lab" type="button" role="tab"
                                aria-controls="pills-order-lab-tab" aria-selected="false">
                                Order Lab
                            </button>
                        </li>
                        <li class="nav-item px-4" role="presentation">
                            <button class="text-navy-blue py-2 px-4 fw-semibold nav-link" id="pills-checkout-tab"
                                data-bs-toggle="pill" data-bs-target="#pills-checkout" type="button" role="tab"
                                aria-controls="pills-checkout" aria-selected="false">
                                Checkout
                            </button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                            ...
                            <div
                                ...
                                <div class="wave-arrow">
                                    <img class="w-100 object-fit-contain"
                                        src="{{ asset('assets/new_frontend/arrow-wave.png') }}" alt="" />
                                </div>
                                <div
                                    ...
                                    <div class="col-md-3">
                                        <div class="w-100 h-100">
                                            ...
                                            <img class="w-100 object-fit-contain"
                                                src="{{ asset('assets/new_frontend/r-step-1.png') }}" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="w-100 h-100">
                                            ...
                                            <img class="w-100 object-fit-contain"
                                                src="{{ asset('assets/new_frontend/laptop.webp') }}" alt="" />
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="w-100 h-100">
                        ...
                        <div class="tab-pane fade" id="pills-register-doctor" role="tabpanel"
                            aria-labelledby="pills-register-doctor" tabindex="0">
                            <div
                                class="guide-img-container d-flex align-items-center justify-content-between position-relative p-3">
                                <div class="wave-arrow">
                                    <img class="w-100 object-fit-contain"
                        ...
                        <div class="tab-pane fade" id="pills-order-medicine" role="tabpanel"
                            aria-labelledby="pills-order-medicine" tabindex="0">
                            <div class="guide-img-container d-flex position-relative p-3">
                                <div class="wave-arrow min-w-80">
                                    <img class="w-100 object-fit-contain"
                                        src="{{ asset('assets/new_frontend/arrow-wave-2.png') }}" alt="" />
                                </div>
                                <div
                        ...
                        <div class="tab-pane fade" id="pills-order-lab" role="tabpanel"
                            aria-labelledby="pills-order-lab" tabindex="0">
                            <div class="guide-img-container d-flex position-relative p-3">
                                <div class="wave-arrow min-w-80">
                                    <img class="w-100 object-fit-contain"
                                        src="{{ asset('assets/new_frontend/arrow-wave-3.png') }}" alt="" />
                                </div>
                                <div
                        ...
                        <div class="tab-pane fade" id="pills-checkout" role="tabpanel" aria-labelledby="pills-checkout"
                            tabindex="0">
                            <div class="guide-img-container d-flex position-relative p-3">
                                <div class="wave-arrow">
                                    <img class="w-100 object-fit-contain"
                                        src="{{ asset('assets/new_frontend/arrow-wave-4.png') }}" alt="" />
                                </div>
                                <div
            ...
            <div class="w-85 px-sm-0">
                <div class="row gx-0 gy-3 gx-sm-3 gy-sm-3">
                        ...
                        <div class="row gy-3 gx-0 g-md-3">
                            <div class="col-md-12">
                                <div
                                    ...
                                    <div class="w-35 d-flex align-items-end justify-content-center">
                                        <img class="w-75 w-sm-100" src="{{ asset('assets/new_frontend/product.webp') }}"
                                            alt="" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div
                                    ...
                                    <img class="w-100" src="{{ asset('assets/new_frontend/baby-care.webp') }}"
                                        alt="" />
                            ...
                            <div class="col-md-6">
                                <div
                                    ...
                                    <img class="w-100" src="{{ asset('assets/new_frontend/multi-vitamins.webp') }}"
                                        alt="" />
                                    <div class="bg-white text-center px-4 py-3 rounded-3">
                    ...
                    <div class="col-md-5 px-sm-auto">
                        <div
                            class="w-100 h-100 bg-light-sky-blue p-3 rounded-4 rounded-sm-3 d-flex flex-column align-items-center justify-content-end">
                            <img class="w-75" src="{{ asset('assets/new_frontend/personal-care.webp') }}"
                                alt="" />
                            <div class="bg-white text-center px-4 py-3 rounded-3">
            ...
            <div class="w-85">
                ...
                <div class="row gx-3 mt-3 position-relative">
                    <div class="col-12 d-block d-sm-none">
                        <div class="w-100">
                            <img class="w-100 rounded-3 object-fit-contain"
                                src="{{ asset('assets/new_frontend/mission-2.webp') }}" alt="" />
                        </div>
                    </div>
                    ...
                    <div class="d-none d-sm-block col-md-3">
                        <div class="w-100 h-100">
                            <img class="w-100 h-100 rounded-3 object-fit-cover"
                                src="{{ asset('assets/new_frontend/mission-1.webp') }}" alt="" />
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="w-100 h-100">
                            ...
                            <a class="cursor-pointer mt-4 px-4 py-2 bg-zinc d-flex align-items-center gap-2 rounded-5 text-white consult-btn"
                                @if (Auth::check()) href="{{ route('patient_evisit_specialization') }}"@else data-bs-toggle="modal" data-bs-target="#loginModal" @endif>
                                <span>Consult Now</span>
                                <span
                                    class="bg-blue rounded-circle new-arrow-icon d-flex align-items-center justify-content-center"><i
                                        class="fa-solid fa-arrow-right"></i></span>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-4 d-none d-sm-block">
                        <div class="w-100 h-100 d-flex flex-column justify-content-between gap-2">
                            <img class="w-100 h-50 rounded-3 object-fit-cover"
                                src="{{ asset('assets/new_frontend/mission-2.webp') }}" alt="" />
                            <img class="w-100 h-50 rounded-3 object-fit-cover"
                                src="{{ asset('assets/new_frontend/mission-3.webp') }}" alt="" />
                        </div>
                    </div>
                                    ...
                                    <div class="card w-100">
                                        <div class="card-body w-100 card-min-size">
                                            <div class="w-100 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <h5 class="card-title mb-0 fs-14">Abdul Mussavir</h5>
                                                    <span
                                                ...
                                                <div class="client-pic rounded-circle overflow-hidden">
                                                    <img class="object-fit-cover w-100 h-100"
                                                        src="{{ asset('assets/new_frontend/user-profile.png') }}"
                                                        alt="" />
                                                </div>
                                            </div>
                                            <p class="card-text text-overflow mt-3 fs-12">
                                                Offer a convenient and effective platform for both online consultations and
                                                in-person visits. Whether attending virtually or in the clinic, the
                                                experience is smooth and well-organized. The physicians are professional,
                                                courteous, and attentive to patients' needs. I would highly recommend these
                                                clinics to anyone seeking quality healthcare.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="carousel-item px-2">
                                    <div class="card w-100">
                                        <div class="card-body w-100 card-min-size">
                                            <div class="w-100 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <h5 class="card-title mb-0 fs-14">Roshaan Rasheed</h5>
                                                    <span
                                                        class="card-subtitle client-rating gap-small text-gold fs-6 mt-0 d-flex align-items-center">
                                                        <span class="">★</span>
                                                        <span class="">★</span>
                                            ...
                                            <p class="card-text mt-3 fs-12 text-overflow">
                                                Community healthcare clinics offer a smooth, professional experience for
                                                both online and in-person visits. The physicians are courteous and skilled.
                                                Highly recommended.
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-5">
                                <div class="text-start left_servi_main services d-none">
                                    <div class="d-flex mb-2">
                                        ...
                                        <h5 class="heading">Progressive Center, 4th Floor Suite#410, Main Shahrah Faisal,
                                            Karachi</h5>
