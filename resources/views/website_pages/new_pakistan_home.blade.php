                        ...
                        <div class="carousel-indicators">
                            @foreach ($banners as $key => $banner)
                                <button type="button" data-bs-target="#carouselExampleIndicators"
                                    data-bs-slide-to="{{ $key }}" class="{{ $key == 0 ? 'active' : '' }}"></button>
                            @endforeach
                        </div>
    ...
    --}}
        ...
        <section id="buttons-section" class="container-fluid mt-5">
            <div class="button-section nav nav-tabs" id="nav-tab" role="tablist">
                <div id="e-visit-tab" class="nav-link active" data-bs-toggle="tab" data-bs-target="#e-visit"
                    type="button" role="tab" aria-controls="e-visit" aria-selected="true">
                ...
                <div id="psychiatry-tab" class="nav-link" data-bs-toggle="tab" data-bs-target="#psychiatry"
                    type="button" role="tab" aria-controls="psychiatry" aria-selected="false">
        ...
        <div class="container1 container-fluid tab-content" id="nav-tabContent">
                        ...
                        <div class="left">
                            ...
                            <div class="doc-btn-container">
                                <div class="doctor-button">
                                    <i class="fa-solid fa-user-doctor"></i>
                                    <a class="doc-btn"
                                        @if (Auth::check()) href="{{ route('patient_evisit_specialization') }}"
                                    @else data-bs-toggle="modal" data-bs-target="#loginModal" @endif>TALK
                                        TO
                                        DOCTORS</a>
                                </div>
                            </div>
            ...
            <section class="tab-pane fade" id="pharmacy" role="tabpanel" aria-labelledby="pharmacy-tab"
                tabindex="0">
                    ...
                    <div class="pharmacy-content">
                        <div class="pharmacy-categories">
                            @foreach ($data['prescribed_medicines_category'] as $item)
                                <div class="pharmacy-category"
                                    onclick="getPharmacyProductByCategory({{ $item->id }},8)">
                                    <i class="fa-solid fa-pills"></i>
                        ...
                        <div class="medicines-container" id="load_pharmacy_item_by_category">
                            <div class="card">
                                ...
                                <div class="med-img"><img src="{{ asset('assets/new_frontend/panadol.png') }}"
                                        alt="img">
                                </div>
            ...
            <section class="tab-pane fade" id="primary-care" role="tabpanel" aria-labelledby="primary-care-tab"
                ...
                <div class="tabs-section-container">
                    <div class="e-visit-content">
                        <div class="left">
                            ...
                            <div class="doc-btn-container">
                                <div class="doctor-button">
                                    <i class="fa-solid fa-user-doctor"></i>
                                    <a class="doc-btn"
                                        @if (Auth::check()) href="{{ route('patient_online_doctors', ['id' => 1]) }}"
                                    @else data-bs-toggle="modal" data-bs-target="#loginModal" @endif>TALK
                                        TO
                                        DOCTORS</a>
                                </div>
                        ...
                        <div class="right">
                            <img width="500px" src=" {{ asset('assets/new_frontend/primary-care.jpg') }}"
                                alt="" />
                        </div>
                    </div>
                </div>
            </section>
            <section class="tab-pane fade" id="psychiatry" role="tabpanel" aria-labelledby="psychiatry-tab"
                tabindex="0">
                <div class="tabs-section-container">
                    <div class="tabs-section-heading">
                        <h2>Psychiatry</h2>
                    ...
                    <div class="psychiatry-container">
                        @foreach ($data['psychiatrist'] as $key => $item)
                            <div class="psychiatry-box">
                                <img src=" {{ asset('assets/new_frontend/depression.png') }}"
                                    alt="{{ $item->title }}" />
                                <p>{{ $item->title }}</p>
                            </div>
                        @endforeach
                    ...
                    <div class="btn-div">
                        <button class="view_all"
                            onclick="location.href='{{ route('psychiatry', ['slug' => ' anxiety']) }}'">View All</button>
                    </div>
                </div>
            </section>
            {{--
