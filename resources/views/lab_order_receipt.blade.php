        ...
        <main>
            <section class="patient-details">
                ...
                <table class="patient">
                    ...
                    <tbody>
                        <tr>
                            <td>{{ $order_cart_items->user->name }}</td>
                            <td>{{ $order_cart_items->user->get_age($order_cart_items->user->id) }}</td>
                            <td>{{ $order_cart_items->user->email }}</td>
                            <td>{{ $order_cart_items->user->phone_number }}</td>
                        </tr>
                    </tbody>
                </table>
            </section>
                ...
                {{-- <h1 class="patient-heading">Prescription Details</h1> --}}
                    <div>
                        ...
                        <table class="prescription">
                            ...
                            <tbody>
                                @foreach ($order_cart_items as $labtest)
                                    <tr>
