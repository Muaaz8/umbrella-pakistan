                ...
                <div class=" breadcrumb-holder">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">General Adults</li>
                        </ol>
                    </nav>

                    <!-- Title -->
                    <h4 class="h4-sm steelblue-color">General Adults</h4>
            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="info-4-img text-center wow fadeInUp" data-wow-delay="0.6s">
                        <img class="img-fluid" src="asset_frontend/images/adult.jpg" alt="info-image">
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="txt-block pc-30 wow fadeInUp" data-wow-delay="0.4s">
                        ...
                        <ul>
                            ...
                            <li><i class="fas fa-genderless"></i> General Mood disorders</li>
                            <li><i class="fas fa-genderless"></i> Anxiety Disorders</li>
                            <li><i class="fas fa-genderless"></i> Panic disorder</li>
                            <li><i class="fas fa-genderless"></i> Obsessive-compulsive Disorders</li>
                            <li><i class="fas fa-genderless"></i> Adult ADHD</li>
                            <li><i class="fas fa-genderless"></i> Schizophrenia and other Psychotic Disorders</li>
