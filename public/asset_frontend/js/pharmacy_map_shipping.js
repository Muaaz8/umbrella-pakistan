$(document).ready(function () {
    $(".shippingPharmacyZipCodeBtn").click(function (e) {
        e.preventDefault();

        let zipCode = $(".shippingPharmacyZipCodeInput").val();

        if (zipCode.length == 0) {
            alert("Please Enter zipcode.");
        } else {
            $(".show_map_1 #map_shipping").show();
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (ress === 0) {
                        ...
                        $(".selectshippingPharmacyNearbyLocation").html("");
                        $(".selectshippingPharmacyNearbyLocation").append(
