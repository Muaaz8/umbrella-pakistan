$(document).ready(function () {
    $(".precribedLabZipCodeBtn").click(function (e) {
        e.preventDefault();

        let zipCode = $(".prescribedLabTestZipCodeInput").val();

        if (zipCode.length == 0) {
            alert("Please Enter zipcode.");
        } else {
            $(".show_map_prescribed_lab #map4").show();
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $(".prescribed_lab_nearby_location").html("");
                    $(".prescribed_lab_nearby_location").append(
